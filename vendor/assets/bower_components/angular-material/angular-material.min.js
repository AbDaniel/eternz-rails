...
!function (e, t, n) {
    ...
    !function () {
        ...
        function e(e, t) {
            e.decorator("$$rAF", ["$delegate", n]), t.theme("default").primaryPalette("indigo").accentPalette("pink").warnPalette("red").backgroundPalette("grey")
        }
        ...
        t.module("material.core", ["material.core.gestures", "material.core.theming"]).config(e), e.$inject = ["$provide", "$mdThemingProvider"]
    }(), function () {
        function e(e, t) {
            function n(e) {
        ...
        t.module("material.core").factory("$mdConstant", e), e.$inject = ["$$rAF", "$sniffer"]
    }(), function () {
        function e(e, n) {
            function o() {
                return [].concat(E)
            ...
            function b(e, o, r, a) {
                ...
                for (var d = u(o); ;) {
                    if (!i(d))return null;
                    var c = d + (e ? -1 : 1), l = null;
                    if (i(c) ? l = E[c] : n && (l = e ? h() : p(), c = u(l)), null === l || c === a)return null;
                    if (r(l))return l;
            ...
            return {
                ...
                first: p,
                last: h,
                next: t.bind(null, b, !1),
                previous: t.bind(null, b, !0),
                hasPrevious: d,
                hasNext: a
            }
        }
        ...
        function e(e, n, o) {
            ...
            var u = {}, f = {}, p = {}, h = {};
            return r.getResponsiveAttribute = l, r.getQuery = c, r.watchResponsiveAttributes = m, r
        }

        t.module("material.core").factory("$mdMedia", e), e.$inject = ["$mdConstant", "$rootScope", "$window"]
    }(), function () {
        var o = 0;
        t.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$window", "$mdConstant", function (r, i, a, d, c, l) {
            function m(e) {
                return e[0] || e
            }
            ...
            var s;
            return s = {
                now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now,
                ...
                disableScrollAround: function (e) {
                    function n() {
                        ...
                        var r = c.getComputedStyle(e[0]).zIndex - 1;
                        isNaN(r) && (r = 99);
                        var d = t.element('<div class="md-scroll-mask" style="z-index: ' + r + '">  <div class="md-scroll-mask-bar"></div></div>');
                        return a.appendChild(d[0]), d.on("wheel", o), d.on("touchmove", o), i.on("keydown", n), function () {
                            d.off("wheel"), d.off("touchmove"), d[0].parentNode.removeChild(d[0]), i.off("keydown", n), delete s.disableScrollAround._enableScrolling
                        }
                    }

                    function o() {
                        var e = a.getAttribute("style") || "", t = a.scrollTop + a.parentElement.scrollTop;
                        return r(a, {
                            position: "fixed",
                            width: "100%",
                            overflowY: "scroll",
                            ...
                            a.setAttribute("style", e), a.scrollTop = t
                        }
                    }
                    ...
                    if (s.disableScrollAround._enableScrolling)return s.disableScrollAround._enableScrolling;
                    e = t.element(e);
                    var a = i[0].body, d = o(), l = n();
                    return s.disableScrollAround._enableScrolling = function () {
                        d(), l(), delete s.disableScrollAround._enableScrolling
                    }
                },
                ...
                floatingScrollbars: function () {
                    if (this.floatingScrollbars.cached === n) {
                        ...
                        i[0].body.appendChild(e[0]), this.floatingScrollbars.cached = e[0].offsetWidth == e[0].childNodes[0].offsetWidth, e.remove()
                    }
                ...
                transitionEndPromise: function (e, t) {
                    function n(t) {
                        t && t.target !== e[0] || (e.off(l.CSS.TRANSITIONEND, n), o.resolve())
                    }

                    t = t || {};
                    var o = d.defer();
                    return e.on(l.CSS.TRANSITIONEND, n), t.timeout && a(n, t.timeout), o.promise
                },
                ...
                throttle: function (e, t) {
                    var n;
                    return function () {
                        var o = this, r = arguments, i = s.now();
                ...
                extractElementByName: function (e, n) {
                    for (var o = 0, r = e.length; r > o; o++)if (e[o].nodeName.toLowerCase() === n)return t.element(e[o]);
                    return e
                },
                initOptionalProperties: function (e, n, o) {
                    o = o || {}, t.forEach(e.$$isolateBindings, function (r, i) {
                        if (r.optional && t.isUndefined(e[i])) {
                            var a = n.hasOwnProperty(n.$normalize(r.attrName));
        ...
        function e(e, n, o, r, i, a) {
            this.compile = function (d) {
                var c = d.templateUrl, l = d.template || "", m = d.controller, s = d.controllerAs, u = d.resolve || {}, f = d.locals || {}, p = d.transformTemplate || t.identity, h = d.bindToController;
                return t.forEach(u, function (e, n) {
                    u[n] = t.isString(e) ? o.get(e) : o.invoke(e)
                }), t.extend(u, f), u.$template = c ? n.get(c, {cache: a}).then(function (e) {
                    return e.data
                }) : e.when(l), e.all(u).then(function (e) {
                    var n = p(e.$template), o = d.element || t.element("<div>").html(n.trim()).contents(), a = r(o);
                    return {
                        locals: e, element: o, link: function (n) {
                            if (e.$scope = n, m) {
                                var r = i(m, e, !0);
                                h && t.extend(r.instance, e);
                                var d = r();
                                o.data("$ngControllerController", d), o.children().data("$ngControllerController", d), s && (n[s] = d)
                            }
                            return a(n)
                        }
                    }
        ...
        function o(n, o, r) {
            function i(e, t, n) {
                var o = f[t.replace(/^\$md./, "")];
                if (!o)throw new Error("Failed to register element with handler " + t + ". Available handlers: " + Object.keys(f).join(", "));
                return o.registerElement(e, n)
            }

            function a(e, o) {
                var r = new n(e);
                return t.extend(r, o), f[e] = r, h
            }

            var c = navigator.userAgent || navigator.vendor || e.opera, m = c.match(/ipad|iphone|ipod/i), s = c.match(/android/i), u = "undefined" != typeof e.jQuery && t.element === e.jQuery, h = {
                handler: a,
                register: i,
                isHijackingClicks: (m || s) && !u && !p
            };
        ...
        function a(e, n) {
            function o(e, t) {
                var o;
                for (var r in f)o = f[r], o instanceof n && ("start" === e && o.cancel(), o[e](t, s))
            }

            function r(e) {
                if (!s) {
                    var t = +Date.now();
                    u && !c(e, u) && t - u.endTime < 1500 || (s = d(e), o("start", e))
                }
            }

            function i(e) {
                s && c(e, s) && (l(e, s), o("move", e))
            }

            function a(e) {
                s && c(e, s) && (l(e, s), s.endTime = +Date.now(), o("end", e), u = s, s = null)
            }
            ...
            document.contains || (document.contains = function (e) {
                ...
                t || e.$material || e.isIonicTap || (e.preventDefault(), e.stopPropagation())
            }, !0), h = !0);
            var m = "mousedown touchstart pointerdown", p = "mousemove touchmove pointermove", b = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
            t.element(document).on(m, r).on(p, i).on(b, a).on("$$mdGestureReset", function () {
                u = s = null
            })
        }
        ...
        function e() {
            function e(e) {
                ...
                function i(n, o, r) {
                    function i(e) {
                        return e && e._options && (e = e._options), s.show(t.extend({}, m, e))
                    }

                    function a(t, n) {
                        var o = {};
                        return o[e] = u, r.invoke(t || function () {
                            return n
                        }, {}, o)
                    }

                    var l, m, s = n(), u = {hide: s.hide, cancel: s.cancel, show: i};
                    return l = c.methods || [], m = a(c.optionsFactory, {}), t.forEach(d, function (e, t) {
                        u[t] = e
                        ...
                        var r = a(e.optionsFactory, {}), i = (e.methods || []).concat(l);
                ...
                var a = ["onHide", "onShow", "onRemove"], d = {}, c = {presets: {}}, l = {
                    setDefaults: n,
                    addPreset: r,
                    addMethod: o,
                    $get: i
                };
                return l.addPreset("build", {methods: ["controller", "controllerAs", "resolve", "template", "templateUrl", "themable", "transformTemplate", "parent"]}), i.$inject = ["$$interimElement", "$animate", "$injector"], l
            }

            function o(e, o, r, i, a, d, c, l, m) {
                function s(e) {
                    return e && t.isString(e) ? e.replace(/\{\{/g, u).replace(/}}/g, f) : e
                }

                var u = c.startSymbol(), f = c.endSymbol(), p = "{{" === u && "}}" === f, h = p ? t.identity : s;
                return function () {
                    function c(e) {
                        if (b.length)return p.cancel().then(function () {
                            return c(e)
                        });
                        var t = new f(e);
                        return b.push(t), t.show().then(function () {
                    ...
                    function u(e) {
                        var t = b.shift();
                        return o.when(t && t.remove().then(function () {
                            t.deferred.reject(e)
                        }))
                    }
                    ...
                    function f(c) {
                        var s, u, f, b, g;
                        return c = c || {}, c = t.extend({
                            preserveScope: !1,
                            scope: c.scope || r.$new(c.isolateScope),
                        ...
                        }, c), c.template && (c.template = h(c.template)), s = {
                            options: c,
                            deferred: o.defer(),
                            show: function () {
                                var n;
                                return n = c.skipCompile ? o(function (e) {
                                    e({
                                        locals: {}, link: function () {
                                            return c.element
                                        }
                                    })
                                }) : l.compile(c), b = n.then(function (n) {
                                    function r() {
                                        c.hideDelay && (u = i(p.cancel, c.hideDelay))
                                    }

                                    if (t.extend(n.locals, s.options), f = n.link(c.scope), t.isFunction(c.parent) ? c.parent = c.parent(c.scope, f, c) : t.isString(c.parent) && (c.parent = t.element(e[0].querySelector(c.parent))), !(c.parent || {}).length) {
                                        var d;
                                        a[0] && a[0].querySelector && (d = a[0].querySelector(":not(svg) > body")), d || (d = a[0]), "#comment" == d.nodeName && (d = e[0].body), c.parent = t.element(d)
                                    }
                                    c.themable && m(f);
                                    var l = c.onShow(c.scope, f, c);
                                    return o.when(l).then(function () {
                                        (c.onComplete || t.noop)(c.scope, f, c), r()
                                    })
                                }, function (e) {
                                    b = !0, s.deferred.reject(e)
                                })
                            },
                            ...
                            remove: function () {
                                return s.cancelTimeout(), g = o.when(b).then(function () {
                                    var e = f ? c.onRemove(c.scope, f, c) : !0;
                                    return o.when(e).then(function () {
                                        c.preserveScope || c.scope.$destroy(), g = !0
                                    })
                                })
                            }
                        }
                    ...
                    var p, b = [];
                    return p = {show: c, hide: s, cancel: u}
                }
            }

            return e.$get = o, o.$inject = ["$document", "$q", "$rootScope", "$timeout", "$rootElement", "$animate", "$interpolate", "$mdCompiler", "$mdTheming"], e
        }
        ...
        !function () {
            function e(e) {
                function n(n, r, i) {
                    var a = o(r);
                    return e.attach(n, r, t.extend(a, i))
                }
        ...
        function n(e, n) {
            function o(o, r, i) {
                function a() {
                    ...
                    return e ? e : (e = t.element('<div class="md-ripple-container">'), r.append(e), r.data("$mdRippleContainer", e), e)
                }

                function d(e) {
                    function t(e) {
                        var t = "#" === e.charAt(0) ? e.substr(1) : e, n = t.length / 3, o = t.substr(0, n), r = t.substr(n, n), i = t.substr(2 * n);
                ...
                function c(e, t) {
                    g.splice(g.indexOf(e), 1), 0 === g.length && a().css({backgroundColor: ""}), n(function () {
                        e.remove()
                    }, t, !1)
                }

                function l(e) {
                    var t = g.indexOf(e), n = E[t] || {}, o = g.length > 1 ? !1 : M, r = g.length > 1 ? !1 : $;
                    o || n.animating || r ? e.addClass("md-ripple-visible") : e && (e.removeClass("md-ripple-visible"), i.outline && e.css({
                        width: p + "px",
                        height: p + "px",
                        marginLeft: -1 * p + "px",
                        marginTop: -1 * p + "px"
                ...
                function m(o, c) {
                    function m(e) {
                        var n = t.element('<div class="md-ripple" data-counter="' + b++ + '">');
                        return g.unshift(n), E.unshift({animating: !0}), f.append(n), e && n.css(e), n
                    }

                    function s(e, t) {
                        var n, o, r, a = f.prop("offsetWidth"), d = f.prop("offsetHeight");
                        return i.isMenuItem ? o = Math.sqrt(Math.pow(a, 2) + Math.pow(d, 2)) : i.outline ? (r = A.getBoundingClientRect(), e -= r.left, t -= r.top, a = Math.max(e, a - e), d = Math.max(t, d - t), o = 2 * Math.sqrt(Math.pow(a, 2) + Math.pow(d, 2))) : (n = i.fullRipple ? 1.1 : .8, o = Math.sqrt(Math.pow(a, 2) + Math.pow(d, 2)) * n, i.fitRipple && (o = Math.min(d, a, o))), o
                    }
                    ...
                    function u(e, t, n) {
                        ...
                        var r = A.getBoundingClientRect(), a = {
                            backgroundColor: o(T),
                            borderColor: o(T),
                            width: e + "px",
                            height: e + "px"
                        };
                        return i.outline ? (a.width = 0, a.height = 0) : a.marginLeft = a.marginTop = e * -.5 + "px", i.center ? a.left = a.top = "50%" : (a.left = Math.round((t - r.left) / f.prop("offsetWidth") * 100) + "%", a.top = Math.round((n - r.top) / f.prop("offsetHeight") * 100) + "%"), a
                    }

                    T = d(r.attr("md-ink-ripple")) || d(e.getComputedStyle(i.colorElement[0]).color || "rgb(0, 0, 0)");
                    var f = a(), h = s(o, c), v = u(h, o, c), M = m(v), $ = g.indexOf(M), C = E[$] || {};
                    return p = h, C.animating = !0, n(function () {
                        i.dimBackground && f.css({backgroundColor: T}), M.addClass("md-ripple-placed md-ripple-scaled"), M.css(i.outline ? {
                            borderWidth: .5 * h + "px",
                            marginLeft: h * -.5 + "px",
                            marginTop: h * -.5 + "px"
                        } : {left: "50%", top: "50%"}), l(M), n(function () {
                            C.animating = !1, l(M)
                        }, i.outline ? 450 : 225, !1)
                    }, 0, !1), M
                }
                ...
                function f() {
                    ...
                    var t = A.parentNode, n = t && t.parentNode, o = n && n.parentNode;
                    return !(e(A) || e(t) || e(n) || e(o))
                }

                if (r.controller("mdNoInk"))return t.noop;
                i = t.extend({
                    colorElement: r,
                    mousedown: !0,
                    hover: !0,
                ...
                var p, h = r.controller("mdInkRipple") || {}, b = 0, g = [], E = [], v = r.attr("md-highlight"), M = !1, $ = !1, A = r[0], C = r.attr("md-ripple-size"), T = d(r.attr("md-ink-ripple")) || d(i.colorElement.length && e.getComputedStyle(i.colorElement[0]).color || "rgb(0, 0, 0)");
                switch (C) {
                    case"full":
                        i.fullRipple = !0;
                        break;
                ...
                return i.mousedown && r.on("$md.pressdown", s).on("$md.pressup", u), h.createRipple = m, v && o.$watch(v, function (e) {
                    M = e, M && !g.length && n(function () {
                        m(0, 0)
                    }, 0, !1), t.forEach(g, l)
                }), function () {
                    r.off("$md.pressdown", s).off("$md.pressup", u), a().remove()
                }
            }
        ...
        t.module("material.core").factory("$mdInkRipple", n).directive("mdInkRipple", e).directive("mdNoInk", o()).directive("mdNoBar", o()).directive("mdNoStretch", o()), e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], n.$inject = ["$window", "$timeout"]
    }(), function () {
        !function () {
            function e(e) {
                function n(n, o, r) {
        ...
        function e(e) {
            ...
            function d(e, n) {
                if (s[e])return s[e];
                n = n || "default";
                var o = "string" == typeof n ? s[n] : n, r = new c(e);
            ...
            function c(e) {
                function n(e) {
                    if (e = 0 === arguments.length ? !0 : !!e, e !== o.isDark) {
                        o.isDark = e, o.foregroundPalette = o.isDark ? p : f, o.foregroundShadow = o.isDark ? h : b;
                        var n = o.isDark ? C : A, r = o.isDark ? A : C;
            ...
            function u(e, o) {
                ...
                return i.inherit = function (n, i) {
                    function a(e) {
                        ...
                        t && n.removeClass("md-" + t + "-theme"), n.addClass("md-" + e + "-theme"), n.data("$mdThemeName", e)
                    }
                ...
                }, i.THEMES = t.extend({}, s), i.defaultTheme = function () {
                    return E
                }, i.registered = r, i
            }
            ...
            m = {}, s = {};
            var g, E = "default", v = !1;
            return t.extend(m, e), u.$inject = ["$rootScope", "$log"], g = {
                definePalette: o,
                extendPalette: r,
                theme: d,
        ...
        function i(e, n, o) {
            ...
            var r = [], i = e.colors[n], a = new RegExp(".md-" + e.name + "-theme", "g"), c = new RegExp("('|\")?{{\\s*(" + n + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"), s = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?\s*\}\}'?"?/g, u = m[i.name];
            return o = o.replace(s, function (t, n, o, r) {
                return "foreground" === n ? "shadow" == o ? e.foregroundShadow : e.foregroundPalette[o] || e.foregroundPalette[1] : (0 === o.indexOf("hue") && (o = e.colors[n].hues[o]), l((m[e.colors[n].name][o] || "").value, r))
        ...
        function a(e) {
            function n(e) {
                ...
                "string" == typeof o && (o = o.split(" ")), "string" == typeof r && (r = r.split(" ")), "string" == typeof i && (i = i.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, t.forEach(e, function (a, d) {
                    function l() {
                        return "light" === n ? i.indexOf(d) > -1 ? g : r.indexOf(d) > -1 ? v : E : o.indexOf(d) > -1 ? r.indexOf(d) > -1 ? v : E : g
                    }

                    if (!t.isObject(a)) {
                        var m = c(a);
                        if (!m)throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", a).replace("%2", e.name).replace("%3", d));
                        e[d] = {value: m, contrast: l()}
                    }
                })
            }
            ...
            if (r && 0 !== a.length) {
                t.forEach(m, n);
                var d = {}, l = a.split(/\}(?!(\}|'|"|;))/).filter(function (e) {
                    return e && e.length
                }).map(function (e) {
                    return e.trim() + "}"
                }), f = new RegExp("md-(" + M.join("|") + ")", "g");
                M.forEach(function (e) {
                    d[e] = ""
                }), l.forEach(function (e) {
                    for (var t, n = (e.match(f), 0); t = M[n]; n++)if (e.indexOf(".md-" + t) > -1)return d[t] += e;
        ...
        }, h = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", b = "", g = c("rgba(0,0,0,0.87)"), E = c("rgba(255,255,255,0.87"), v = c("rgb(255,255,255)"), M = ["primary", "accent", "warn", "background"], $ = "primary", A = {
            accent: {
                "default": "A200",
                "hue-1": "A100",
                "hue-2": "A400",
        ...
        }, C = {background: {"default": "800", "hue-1": "300", "hue-2": "600", "hue-3": "900"}};
        M.forEach(function (e) {
        ...
        t.module("material.components.backdrop", ["material.core"]).directive("mdBackdrop", e), e.$inject = ["$mdTheming"]
    }(), function () {
        function e() {
            return {restrict: "E"}
        }
        ...
        function n(e) {
            function n(e, n, i, a, d, c, l, m, s) {
                function u(o, r, s) {
                    r = i.extractElementByName(r, "md-bottom-sheet"), h = d('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(o), h.on("click", function () {
                        a(l.cancel)
                    }), c.inherit(h, s.parent), e.enter(h, s.parent, null);
                    var u = new p(r, s.parent);
                    return s.bottomSheet = u, s.targetEvent && t.element(s.targetEvent.target).blur(), c.inherit(u.element, s.parent), s.disableParentScroll && (s.lastOverflow = s.parent.css("overflow"), s.parent.css("overflow", "hidden")), e.enter(u.element, s.parent).then(function () {
                        var e = t.element(r[0].querySelector("button") || r[0].querySelector("a") || r[0].querySelector("[ng-click]"));
                        e.focus(), s.escapeToClose && (s.rootElementKeyupCallback = function (e) {
                            e.keyCode === n.KEY_CODE.ESCAPE && a(l.cancel)
                        }, m.on("keyup", s.rootElementKeyupCallback))
                    })
                }
                ...
                function f(n, o, r) {
                    ...
                    return e.leave(h), e.leave(i.element).then(function () {
                        r.disableParentScroll && (r.parent.css("overflow", r.lastOverflow), delete r.lastOverflow), i.cleanup(), r.targetEvent && t.element(r.targetEvent.target).focus()
                    })
                }
                ...
                function p(e, t) {
                    ...
                    function c(t) {
                        if (t.pointer.distanceY > 0 && (t.pointer.distanceY > 20 || Math.abs(t.pointer.velocityY) > o)) {
                            var r = e.prop("offsetHeight") - t.pointer.distanceY, i = Math.min(r / t.pointer.velocityY * .75, 500);
                            e.css(n.CSS.TRANSITION_DURATION, i + "ms"), a(l.cancel)
                        } else e.css(n.CSS.TRANSITION_DURATION, ""), e.css(n.CSS.TRANSFORM, "")
                    }

                    var m = s.register(t, "drag", {horizontal: !1});
                    return t.on("$md.dragstart", i).on("$md.drag", d).on("$md.dragend", c), {
                        element: e,
                        cleanup: function () {
                            m(), t.off("$md.dragstart", i).off("$md.drag", d).off("$md.dragend", c)
                        }
                    }
                }
            ...
            var o = .5, r = 80;
            return n.$inject = ["$animate", "$mdConstant", "$mdUtil", "$timeout", "$compile", "$mdTheming", "$mdBottomSheet", "$rootElement", "$mdGesture"], e("$mdBottomSheet").setDefaults({
                methods: ["disableParentScroll", "escapeToClose", "targetEvent"],
                options: n
            })
        }

        t.module("material.components.bottomSheet", ["material.core", "material.components.backdrop"]).directive("mdBottomSheet", e).provider("$mdBottomSheet", n), n.$inject = ["$$interimElementProvider"]
    }(), function () {
        function e(e, n, o, r) {
            function i(e) {
            ...
            function d(a, d, c) {
                var l = d[0];
                n(d), e.attach(a, d);
                var m = l.textContent.trim();
                m || o.expect(d, "aria-label"), i(c) && t.isDefined(c.ngDisabled) && a.$watch(c.ngDisabled, function (e) {
        ...
        function e(e, n, o, r, i, a, d) {
            function c(n, c) {
                return c.type = "checkbox", c.tabindex = c.tabindex || "0", n.attr("role", c.type), function (n, c, m, s) {
                    function u(e, t, o) {
                        m[e] && n.$watch(m[e], function (e) {
                            o[e] && c.attr(t, o[e])
                        })
                    }
                    ...
                    function f(e) {
                        ...
                        (t === r.KEY_CODE.SPACE || t === r.KEY_CODE.ENTER) && (e.preventDefault(), c.hasClass("md-focused") || c.addClass("md-focused"), p(e))
                    }

                    function p(e) {
                        c[0].hasAttribute("disabled") || n.$apply(function () {
                            var t = m.ngChecked ? m.checked : !s.$viewValue;
                            s.$setViewValue(t, e && e.type), s.$render()
                        })
                    }

                    function h() {
                        s.$viewValue ? c.addClass(l) : c.removeClass(l)
                    }

                    s = s || a.fakeNgModel(), i(c), m.ngChecked && n.$watch(n.$eval.bind(n, m.ngChecked), s.$setViewValue.bind(s)), u("ngDisabled", "tabindex", {
                        "true": "-1",
                        "false": m.tabindex
                    }), o.expectWithText(c, "aria-label"), e.link.pre(n, {
                        on: t.noop,
                        0: {}
                    }, m, [s]), n.mouseActive = !1, c.on("click", p).on("keypress", f).on("mousedown", function () {
                        n.mouseActive = !0, d(function () {
                            n.mouseActive = !1
                        }, 100)
                    }).on("focus", function () {
                        n.mouseActive === !1 && c.addClass("md-focused")
                    }).on("blur", function () {
        ...
        t.module("material.components.checkbox", ["material.core"]).directive("mdCheckbox", e), e.$inject = ["inputDirective", "$mdInkRipple", "$mdAria", "$mdConstant", "$mdTheming", "$mdUtil", "$timeout"]
    }(), function () {
        function e(e) {
            function t(e, t) {
        ...
        function e(e, t) {
            return {
                restrict: "E", link: function (n, o, r) {
                    t(o), e(function () {
                        var e = o[0].querySelector("md-dialog-content");
        ...
        function n(e) {
            function n(e, t) {
                return {
                    template: ['<md-dialog md-theme="{{ dialog.theme }}" aria-label="{{ dialog.ariaLabel }}">', '<md-dialog-content role="document" tabIndex="-1">', '<h2 class="md-title">{{ dialog.title }}</h2>', "<p>{{ dialog.content }}</p>", "</md-dialog-content>", '<div class="md-actions">', '<md-button ng-if="dialog.$type == \'confirm\'" ng-click="dialog.abort()" class="md-primary">', "{{ dialog.cancel }}", "</md-button>", '<md-button ng-click="dialog.hide()" class="md-primary">', "{{ dialog.ok }}", "</md-button>", "</div>", "</md-dialog>"].join(""),
                    controller: function () {
                        this.hide = function () {
                            e.hide(!0)
                        }, this.abort = function () {
            ...
            function o(e, n, o, r, i, a, d, c, l, m, s) {
                function u(e) {
                ...
                function f(e, m, s) {
                    function f() {
                        var e = m[0].querySelector(".dialog-close");
                        if (!e) {
                            var n = m[0].querySelectorAll(".md-actions button");
                            e = n[n.length - 1]
                        }
                        return t.element(e)
                    }

                    t.element(n[0].body).addClass("md-dialog-is-showing"), m = o.extractElementByName(m, "md-dialog"), s.parent = t.element(s.parent), s.popInTarget = t.element((s.targetEvent || {}).target);
                    var p = f();
                    if (s.hasBackdrop) {
                        var b = s.parent[0] == n[0].body && n[0].documentElement && n[0].documentElement.scrollTop ? t.element(n[0].documentElement) : s.parent, v = b.prop("scrollTop");
                        s.backdrop = t.element('<md-backdrop class="md-dialog-backdrop md-opaque">'), s.backdrop.css("top", v + "px"), i.inherit(s.backdrop, s.parent), l.enter(s.backdrop, s.parent), m.css("top", v + "px")
                    }
                    var M = "dialog", $ = p;
                    return "alert" === s.$type && (M = "alertdialog", $ = m.find("md-dialog-content")), h(m.find("md-dialog"), M, s), document.addEventListener("focus", u, !0), s.disableParentScroll && (s.lastOverflow = s.parent.css("overflow"), s.parent.css("overflow", "hidden")), E(m, s.parent, s.popInTarget && s.popInTarget.length && s.popInTarget).then(function () {
                        g(m, !0), s.escapeToClose && (s.rootElementKeyupCallback = function (e) {
                            e.keyCode === r.KEY_CODE.ESCAPE && d(a.cancel)
                        }, c.on("keyup", s.rootElementKeyupCallback)), s.clickOutsideToClose && (s.dialogClickOutsideCallback = function (e) {
                            e.target === m[0] && d(a.cancel)
                        }, m.on("click", s.dialogClickOutsideCallback)), s.focusOnOpen && $.focus()
                    })
                }

                function p(e, o, r) {
                    return t.element(n[0].body).removeClass("md-dialog-is-showing"), r.backdrop && l.leave(r.backdrop), r.disableParentScroll && (r.parent.css("overflow", r.lastOverflow), delete r.lastOverflow), r.escapeToClose && c.off("keyup", r.rootElementKeyupCallback), r.clickOutsideToClose && o.off("click", r.dialogClickOutsideCallback), g(o, !1), document.removeEventListener("focus", u, !0), v(o, r.parent, r.popInTarget && r.popInTarget.length && r.popInTarget).then(function () {
                        o.remove(), r.popInTarget && r.popInTarget.focus()
                    })
                }

                function h(t, n, r) {
                    t.attr({role: n, tabIndex: "-1"});
                    var i = t.find("md-dialog-content");
                    0 === i.length && (i = t);
                    var a = t.attr("id") || "dialog_" + o.nextUid();
                    i.attr("id", a), t.attr("aria-describedby", a), r.ariaLabel ? e.expect(t, "aria-label", r.ariaLabel) : e.expectAsync(t, "aria-label", function () {
                ...
                function g(e, t) {
                    function n(e) {
                        for (; e.parentNode;) {
                            ...
                            for (var r = e.parentNode.children, i = 0; i < r.length; i++)e === r[i] || b(r[i], ["SCRIPT", "STYLE"]) || r[i].setAttribute(o, t);
                            n(e = e.parentNode)
                        }
                    }
                ...
                function E(e, t, n) {
                    ...
                    return t.append(e), M(i, n), m(function () {
                        i.addClass("transition-in").css(r.CSS.TRANSFORM, "")
                    }), o.transitionEndPromise(i)
                }

                function v(e, t, n) {
                    var r = e.find("md-dialog");
                    return r.addClass("transition-out").removeClass("transition-in"), M(r, n), o.transitionEndPromise(r)
                }

                function M(e, t) {
                    if (t) {
                        var n = t[0].getBoundingClientRect(), o = e[0].getBoundingClientRect(), i = Math.min(.5, n.width / o.width), a = Math.min(.5, n.height / o.height);
                        e.css(r.CSS.TRANSFORM, "translate3d(" + (-o.left + n.left + n.width / 2 - o.width / 2) + "px," + (-o.top + n.top + n.height / 2 - o.height / 2) + "px,0) scale(" + i + "," + a + ")")
                    }
                }
            ...
            return n.$inject = ["$mdDialog", "$mdTheming"], o.$inject = ["$mdAria", "$document", "$mdUtil", "$mdConstant", "$mdTheming", "$mdDialog", "$timeout", "$rootElement", "$animate", "$$rAF", "$q"], e("$mdDialog").setDefaults({
                ...
                options: n
            }).addPreset("confirm", {methods: ["title", "content", "ariaLabel", "ok", "cancel", "theme"], options: n})
        }

        t.module("material.components.dialog", ["material.core", "material.components.backdrop"]).directive("mdDialog", e).provider("$mdDialog", n), e.$inject = ["$$rAF", "$mdTheming"], n.$inject = ["$$interimElementProvider"]
    }(), function () {
        !function () {
            function e() {
                return {
                    restrict: "E", require: ["^?mdFabSpeedDial", "^?mdFabToolbar"], link: function (e, n, o, r) {
                        var i = r[0] || r[1];
                        i && t.forEach(n.children(), function (e) {
                            t.element(e).on("focus", i.open), t.element(e).on("blur", i.close)
                        }), n.children().wrap('<div class="md-fab-action-item">')
                    }
                }
            }
        ...
        !function () {
            function e() {
                ...
                function t(e, t, n) {
                    function o() {
                        a.direction = a.direction || "down", a.isOpen = a.isOpen || !1
                    }

                    function r() {
                        t.on("mouseenter", a.open), t.on("mouseleave", a.close)
                    }

                    function i() {
                        e.$watch("vm.direction", function (e, o) {
                            n.removeClass(t, "md-" + o), n.addClass(t, "md-" + e)
                        }), e.$watch("vm.isOpen", function (e) {
                            var o = e ? "md-is-open" : "", r = e ? "" : "md-is-open";
                            n.setClass(t, o, r)
                        })
                    }
                    ...
                    var a = this;
                    a.open = function () {
                        e.$apply("vm.isOpen = true")
                    }, a.close = function () {
                        e.$apply("vm.isOpen = false")
                    }, o(), r(), i()
                }

                return t.$inject = ["$scope", "$element", "$animate"], {
                    restrict: "E",
            ...
            function n() {
                function e(e) {
                    var n = e[0], o = e.controller("mdFabSpeedDial"), r = n.querySelectorAll(".md-fab-action-item"), i = n.querySelector(".md-css-variables"), a = i.style.zIndex;
                    t.forEach(r, function (e, t) {
                        var n = e.style;
                        n.transform = "", n.transitionDelay = "", n.opacity = 1, e.style.zIndex = r.length - t + a
                    }), o.isOpen || t.forEach(r, function (e, t) {
                        var n, r;
                        switch (o.direction) {
                            case"up":
                        ...
                        e.style.transform = "translate" + r + "(" + n + "px)"
                    })
                }

                return {
                    addClass: function (t, n, o) {
                        t.hasClass("md-fling") && e(t)
            ...
            function o() {
                function e(e) {
                    ...
                    t.forEach(i, function (e, t) {
                        var o = e.style, a = t * n;
                        o.opacity = r.isOpen ? 1 : 0, o.transform = r.isOpen ? "scale(1)" : "scale(0)", o.transitionDelay = (r.isOpen ? a : i.length - a) + "ms"
                    })
                }
            ...
            t.module("material.components.fabSpeedDial", ["material.core", "material.components.fabTrigger", "material.components.fabActions"]).directive("mdFabSpeedDial", e).animation(".md-fling", n).animation(".md-scale", o)
        }()
    }(), function () {
        !function () {
            function n() {
                function e(e, t, n) {
                    var o = this;
                    o.isOpen = o.isOpen || !1, o.open = function () {
                        o.isOpen = !0, e.$apply()
                    }, o.close = function () {
                        o.isOpen = !1, e.$apply()
                    }, t.addClass("md-fab-toolbar"), t.on("mouseenter", o.open), t.on("mouseleave", o.close), e.$watch("vm.isOpen", function (e) {
                        var o = e ? "md-is-open" : "", r = e ? "" : "md-is-open";
                        n.setClass(t, o, r)
                    })
                }
                ...
                function t(e, t, n) {
                    t.find("md-fab-trigger").find("button").attr("tabindex", "-1"), t.find("md-fab-trigger").find("button").prepend('<div class="md-fab-toolbar-background"></div>')
                }

                return e.$inject = ["$scope", "$element", "$animate"], {
                    restrict: "E",
                    transclude: !0,
            ...
            function o() {
                function n(n, o, r) {
                    var i = n[0], a = n.controller("mdFabToolbar"), d = i.querySelector(".md-fab-toolbar-background"), c = i.querySelector("md-fab-trigger button"), l = i.querySelector("md-fab-trigger button md-icon"), m = n.find("md-fab-actions").children();
                    if (c && d) {
                        var s = e.getComputedStyle(c).getPropertyValue("background-color"), u = i.offsetWidth, f = (i.offsetHeight, 2 * u);
                        d.style.backgroundColor = s, d.style.borderRadius = u + "px", a.isOpen ? (d.style.width = f + "px", d.style.height = f + "px", d.style.top = -(f / 2) + "px", n.hasClass("md-left") && (d.style.left = -(f / 2) + "px", d.style.right = null), n.hasClass("md-right") && (d.style.right = -(f / 2) + "px", d.style.left = null), d.style.transitionDelay = "0ms", l.style.transitionDelay = ".3s", t.forEach(m, function (e, t) {
                            e.style.transitionDelay = 25 * (m.length - t) + "ms"
                        })) : (d.style.width = c.offsetWidth + "px", d.style.height = c.offsetHeight + "px", d.style.top = "0px", n.hasClass("md-left") && (d.style.left = "0px", d.style.right = null), n.hasClass("md-right") && (d.style.right = "0px", d.style.left = null), d.style.transitionDelay = "200ms", l.style.transitionDelay = "0ms", t.forEach(m, function (e, t) {
                            e.style.transitionDelay = 25 * t + "ms"
                        }))
                    }
                }
            ...
            t.module("material.components.fabToolbar", ["material.core", "material.components.fabTrigger", "material.components.fabActions"]).directive("mdFabToolbar", n).animation(".md-fab-toolbar", o)
        }()
    }(), function () {
        function e(e, o, r, i) {
            function a(n, a, d, c) {
                function l() {
                    ...
                    return i.watchResponsiveAttributes(["md-cols", "md-row-height"], d, s)
                }
                ...
                function u(e) {
                    var o = b(), i = {tileSpans: g(o), colCount: E(), rowMode: $(), rowHeight: M(), gutter: v()};
                    if (e || !t.equals(i, y)) {
                        var d = r(i.colCount, i.tileSpans, o).map(function (e, n) {
                            return {
                                grid: {element: a, style: h(i.colCount, n, i.gutter, i.rowMode, i.rowHeight)},
                                tiles: e.map(function (e, n) {
                                    return {
                                        element: t.element(o[n]),
                                        style: p(e.position, e.spans, i.colCount, i.rowCount, i.gutter, i.rowMode, i.rowHeight)
                                    }
                                })
                            }
                        }).reflow().performance();
                        n.mdOnLayout({$event: {performance: d}}), y = i
                    }
                }
                ...
                function p(e, t, n, o, r, i, a) {
                    var d = 1 / n * 100, c = (n - 1) / n, l = x({
                        share: d,
                        gutterShare: c,
                        gutter: r
                    }), m = {
                        left: N({unit: l, offset: e.col, gutter: r}),
                        width: _({unit: l, span: t.col, gutter: r}),
                        paddingTop: "",
                        marginTop: "",
                        top: "",
                        height: ""
                    ...
                    switch (i) {
                        case"fixed":
                            m.top = N({unit: a, offset: e.row, gutter: r}), m.height = _({
                                unit: a,
                                span: t.row,
                                gutter: r
                            });
                            break;
                        case"ratio":
                            var s = d / a, u = x({share: s, gutterShare: c, gutter: r});
                            m.paddingTop = _({unit: u, span: t.row, gutter: r}), m.marginTop = N({
                                unit: u,
                                offset: e.row,
                                gutter: r
                            });
                            break;
                        case"fit":
                            var f = (o - 1) / o, s = 1 / o * 100, u = x({share: s, gutterShare: f, gutter: r});
                            m.top = N({unit: u, offset: e.row, gutter: r}), m.height = _({
                                unit: u,
                                span: t.row,
                                gutter: r
                            })
                ...
                function h(e, t, n, o, r) {
                    ...
                    switch (o) {
                        case"fixed":
                            ...
                            break;
                        case"ratio":
                            var a = 1 === e ? 0 : (e - 1) / e, d = 1 / e * 100, c = d * (1 / r), l = x({
                                share: c,
                                gutterShare: a,
                                gutter: n
                            });
                            i.paddingBottom = _({unit: l, span: t, gutter: n});
                            break;
                        case"fit":
                    }
                    return i
                ...
                function v() {
                    return A(i.getResponsiveAttribute(d, "md-gutter") || 1)
                }
                ...
                var C = t.bind(c, c.invalidateLayout), T = l();
                n.$on("$destroy", m);
                var y, k = e.startSymbol(), w = e.endSymbol(), x = e(f("share") + "% - (" + f("gutter") + " * " + f("gutterShare") + ")"), N = e("calc((" + f("unit") + " + " + f("gutter") + ") * " + f("offset") + ")"), _ = e("calc((" + f("unit") + ") * " + f("span") + " + (" + f("span") + " - 1) * " + f("gutter") + ")")
            }
        ...
        function n(e) {
            this.layoutInvalidated = !1, this.tilesInvalidated = !1, this.$timeout_ = e, this.layoutDelegate = t.noop
        }
        ...
        function o(e) {
            function n(t, n) {
                ...
                return c = e.time(function () {
                    ...
                    layoutInfo: function () {
                        ...
                        return {tileCount: n.length, layoutTime: c, mapTime: l, reflowTime: m, totalTime: c + l + m}
                    }
                }
            }
            ...
            function r(e, t) {
                function n(t, n) {
                    ...
                    for (var a = 0, m = 0; m - a < t.col;)d >= e ? o() : (a = l.indexOf(0, d), -1 !== a && -1 !== (m = i(a + 1)) ? d = m + 1 : (a = m = 0, o()));
                ...
                function r(e, t, n) {
                    for (var o = e; e + t > o; o++)l[o] = Math.max(l[o] + n, 0)
                }
        ...
        t.module("material.components.gridList", ["material.core"]).directive("mdGridList", e).directive("mdGridTile", r).directive("mdGridTileFooter", i).directive("mdGridTileHeader", i).factory("$mdGridLayout", o), e.$inject = ["$interpolate", "$mdConstant", "$mdGridLayout", "$mdMedia"], n.$inject = ["$timeout"], n.prototype = {
        ...
        function e(e, t, n, o) {
            function r(o, r, i) {
                ...
                function d() {
                    o.svgIcon || o.svgSrc || (o.fontIcon ? (r.addClass("md-font"), r.addClass(o.fontIcon)) : r.addClass(e.fontSet(o.fontSet)))
                }

                t(r), d();
                var c = i.alt || o.fontIcon || o.svgIcon || r.text(), l = i.$normalize(i.$attr.mdSvgIcon || i.$attr.mdSvgSrc || "");
                i["aria-label"] || ("" == c || a() ? r.text() || n.expect(r, "aria-hidden", "true") : (n.expect(r, "aria-label", c), n.expect(r, "role", "img"))), l && i.$observe(l, function (t) {
        ...
        t.module("material.components.icon", ["material.core"]).directive("mdIcon", e), e.$inject = ["$mdIcon", "$mdTheming", "$mdAria", "$interpolate"]
    }(), function () {
        function e() {
        }
        ...
        function o(e, n, o, r, i) {
            function a(e) {
                return e = e || "", E[e] ? o.when(E[e].clone()) : v.test(e) ? s(e).then(c(e)) : (-1 == e.indexOf(":") && (e = "$default:" + e), l(e)["catch"](m)["catch"](u)["catch"](f).then(c(e)))
            }
            ...
            function c(t) {
                return function (n) {
                    return E[t] = p(n) ? n : new h(n, e[t]), E[t].clone()
                }
            }

            function l(t) {
                var n = e[t];
                return n ? s(n.url).then(function (e) {
                    return new h(e, n)
                }) : o.reject(t)
            }
            ...
            function m(t) {
                function n(e) {
                    var n = t.slice(t.lastIndexOf(":") + 1), r = e.querySelector("#" + n);
                    return r ? new h(r, i) : o.reject(t)
                }

                var r = t.substring(0, t.lastIndexOf(":")) || "$default", i = e[r];
                return i ? s(i.url).then(n) : o.reject(t)
            }
            ...
            function u(e) {
                var n;
                return t.isString(e) && (n = "icon " + e + " not found", r.warn(n)), o.reject(n || e)
            }
            ...
            var E = {}, v = /[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/i;
            return h.prototype = {clone: g, prepare: b}, a.fontSet = d, a
        }
        ...
        e.prototype = {
            icon: function (e, t, o) {
                ...
                r.fontSets.push({alias: e, fontSet: t || e})
        ...
        function o(e, n, o) {
            function r(r, i, a, d) {
                function c(e) {
                    return s.setHasValue(!u.$isEmpty(e)), e
                }

                function l() {
                    s.setHasValue(i.val().length > 0 || (i[0].validity || {}).badInput)
                }
                ...
                function m() {
                    ...
                    function c(e) {
                        l.scrollTop = 0;
                        var t = l.scrollHeight - l.offsetHeight, n = l.offsetHeight + t;
                        l.style.height = n + "px"
                    }

                    var l = i[0], m = e.debounce(a, 1);
                    u ? (u.$formatters.push(o), u.$viewChangeListeners.push(o)) : m(), i.on("keydown input", m), i.on("scroll", c), t.element(n).on("resize", m), r.$on("$destroy", function () {
                        t.element(n).off("resize", m)
                    })
                }

                var s = d[0], u = d[1] || e.fakeNgModel(), f = t.isDefined(a.readonly);
                if (s) {
                    if (s.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");
                    s.input = i, s.label || o.expect(i, "aria-label", i.attr("placeholder")), i.addClass("md-input"), i.attr("id") || i.attr("id", "input_" + e.nextUid()), "textarea" === i[0].tagName.toLowerCase() && m();
                    var p = s.isErrorGetter || function () {
                            return u.$invalid && u.$touched
                        };
                    r.$watch(p, s.setInvalid), u.$parsers.push(c), u.$formatters.push(c), i.on("input", l), f || i.on("focus", function (e) {
                        s.setFocused(!0)
                    }).on("blur", function (e) {
                        s.setFocused(!1), l()
        ...
        function r(e) {
            function n(n, o, r, i) {
                function a(e) {
                    return m.text((o.val() || e || "").length + "/" + d), e
                }

                var d, c = i[0], l = i[1], m = t.element('<div class="md-char-counter">');
                r.$set("ngTrim", "false"), l.element.append(m), c.$formatters.push(a), c.$viewChangeListeners.push(a), o.on("input keydown", function () {
                    a()
                }), n.$watch(r.mdMaxlength, function (n) {
                    d = n, t.isNumber(n) && n > 0 ? (m.parent().length || e.enter(m, l.element, t.element(l.element[0].lastElementChild)), a()) : e.leave(m)
        ...
        function i(e) {
            function n(n, r, i, a) {
                if (a && -1 == o.indexOf(r[0].nodeName) && !t.isDefined(a.element.attr("md-no-float"))) {
                    var d = i.placeholder;
                    if (r.removeAttr("placeholder"), 0 == a.element.find("label").length) {
                        var c = '<label ng-click="delegateClick()">' + d + "</label>";
                        a.element.addClass("md-icon-float"), a.element.prepend(c)
                    } else e.warn("The placeholder='" + d + "' will be ignored since this md-input-container has a child label element.")
                }
            }
        ...
        t.module("material.components.input", ["material.core"]).directive("mdInputContainer", e).directive("label", n).directive("input", o).directive("textarea", o).directive("mdMaxlength", r).directive("placeholder", i), e.$inject = ["$mdTheming", "$parse"], o.$inject = ["$mdUtil", "$window", "$mdAria"], r.$inject = ["$animate"], i.$inject = ["$log"]
    }(), function () {
        function e(e) {
            return {
        ...
        function n(e, n, o) {
            var r = ["md-checkbox", "md-switch"];
            return {
                restrict: "E", controller: "MdListController", compile: function (i, a) {
                    function d() {
                        for (var e, t, n = ["md-switch", "md-checkbox"], o = 0; t = n[o]; ++o)if ((e = i.find(t)[0]) && !e.hasAttribute("aria-label")) {
                            var r = i.find("p")[0];
                            if (!r)return;
                    ...
                    function c(n) {
                        var o;
                        if ("div" == n)o = t.element('<div class="md-no-style md-list-item-inner">'), o.append(i.contents()), i.addClass("md-proxy-focus"); else {
                            ...
                            t.forEach(r, function (e) {
                                i[0].hasAttribute(e) && (o[0].setAttribute(e, i[0].getAttribute(e)), i[0].removeAttribute(e))
                            }), o.children().eq(0).append(i.contents())
                        }
                        if (i[0].setAttribute("tabindex", "-1"), i.append(o), f && f.hasAttribute("ng-click")) {
                            e.expect(f, "aria-label");
                            var d = t.element('<md-button class="md-secondary-container md-icon-button">');
                            d.attr("ng-click", f.getAttribute("ng-click")), f.removeAttribute("ng-click"), f.setAttribute("tabindex", "-1"), f.classList.remove("md-secondary"), d.append(f), f = d[0]
                        }
                        f && (f.hasAttribute("ng-click") || a.ngClick && l(f)) && (i.addClass("md-with-secondary"), i.append(f))
                    }

                    function l(e) {
                        return -1 != r.indexOf(e.nodeName.toLowerCase())
                    }

                    function m(e, i, a, d) {
                        function c() {
                            var e = i.children();
                            e.length && !e[0].hasAttribute("ng-click") && t.forEach(r, function (e) {
                                t.forEach(s.querySelectorAll(e), function (e) {
                                    m.push(e)
                                })
                            })
                        }
                        ...
                        function l() {
                            (m.length || u) && (i.addClass("md-clickable"), d.attachRipple(e, t.element(i[0].querySelector(".md-no-style"))))
                        }

                        var m = [], s = i[0].firstElementChild, u = s && s.hasAttribute("ng-click");
                        c(), l(), i.hasClass("md-proxy-focus") && m.length && t.forEach(m, function (n) {
                            n = t.element(n), e.mouseActive = !1, n.on("mousedown", function () {
                                e.mouseActive = !0, o(function () {
                                    e.mouseActive = !1
                                }, 100)
                            }).on("focus", function () {
                                e.mouseActive === !1 && i.addClass("md-focused"), n.on("blur", function t() {
                                    i.removeClass("md-focused"), n.off("blur", t)
                                })
                            })
                        }), u || m.length || s && s.addEventListener("keypress", function (e) {
                            if ("INPUT" != e.target.nodeName && "TEXTAREA" != e.target.nodeName) {
                                var t = e.which || e.keyCode;
                                t == n.KEY_CODE.SPACE && s && (s.click(), e.preventDefault(), e.stopPropagation())
                            }
                        }), i.off("click"), i.off("keypress"), m.length && s && i.children().eq(0).on("click", function (e) {
                            s.contains(e.target) && t.forEach(m, function (n) {
                                e.target === n || n.contains(e.target) || t.element(n).triggerHandler("click")
                            })
                        })
                    }

                    var s, u, f = i[0].querySelector(".md-secondary");
                    if (i[0].setAttribute("role", "listitem"), a.ngClick)c("button"); else {
                        for (var p, h = 0; p = r[h]; ++h)if (u = i[0].querySelector(p)) {
                            s = !0;
                            break
                        }
                        s ? c("div") : i[0].querySelector("md-button") || i.addClass("md-no-proxy")
                    }
                    return d(), m
                }
            }
        ...
        t.module("material.components.list", ["material.core"]).controller("MdListController", o).directive("mdList", e).directive("mdListItem", n), e.$inject = ["$mdTheming"], n.$inject = ["$mdAria", "$mdConstant", "$timeout"], o.$inject = ["$scope", "$element", "$mdListInkRipple"]
    }(), function () {
        function e(e) {
            function n(e) {
                e.addClass("md-menu");
                var t = e.children()[0];
                if (t.hasAttribute("ng-click") || (t = t.querySelector("[ng-click]")), t && t.setAttribute("aria-haspopup", "true"), 2 != e.children().length)throw Error("Invalid HTML for md-menu. Expected two children elements.");
                return o
            }

            function o(e, n, o, r) {
                var i = t.element('<div class="md-open-menu-container md-whiteframe-z2"></div>'), a = n.children()[1];
                i.append(a), r.init(i), e.$on("$destroy", function () {
                    r.isOpen && (i.remove(), r.close())
                })
            }

            return {restrict: "E", require: "mdMenu", controller: "mdMenuCtrl", scope: !0, compile: n}
        }

        function n(e, t, n, o) {
            var r, i, a = this;
            this.init = function (e) {
                r = e, i = n[0].querySelector("[ng-click]")
            }, this.open = function () {
                a.isOpen = !0, i.setAttribute("aria-expanded", "true"), e.show({
                    mdMenuCtrl: a,
                    element: r,
                    target: n[0]
                })
            }, o.$mdOpenMenu = this.open, this.close = function (t) {
                a.isOpen = !1, i.setAttribute("aria-expanded", "false"), e.hide(), t || n.children()[0].focus()
        ...
        t.module("material.components.menu", ["material.core", "material.components.backdrop"]).directive("mdMenu", e).controller("mdMenuCtrl", n), e.$inject = ["$mdMenu"], n.$inject = ["$mdMenu", "$attrs", "$element", "$scope"]
    }(), function () {
        function e(e) {
            function o(e, o, i, a, d, c, l) {
                function m(n, r, l) {
                    function m() {
                        if (!l.target)throw Error("$mdMenu.show() expected a target to animate from in options.target");
                        t.extend(l, {
                            alreadyOpen: !1,
                            isRemoved: !1,
                            target: t.element(l.target),
                            parent: t.element(l.parent),
                            menuContentEl: t.element(r[0].querySelector("md-menu-content")),
                            backdrop: l.hasBackdrop && t.element('<md-backdrop class="md-menu-backdrop md-click-catcher">')
                        })
                    }
                    ...
                    function u() {
                        l.resizeFn = function () {
                            p(r, l)
                        }, t.element(o).on("resize", l.resizeFn), t.element(o).on("orientationchange", l.resizeFn)
                    }

                    function f() {
                        l.parent.append(r), r.removeClass("md-leave"), e(function () {
                            e(function () {
                                p(r, l), e(function () {
                                    r.addClass("md-active"), l.alreadyOpen = !0, r[0].style[c.CSS.TRANSFORM] = ""
                                })
                            })
                        })
                    }
                    ...
                    function h() {
                        r.addClass("md-clickable"), l.backdrop && l.backdrop.on("click", function (e) {
                            e.preventDefault(), e.stopPropagation(), l.mdMenuCtrl.close(!0)
                        }), l.menuContentEl.on("keydown", function (e) {
                            n.$apply(function () {
                                switch (e.keyCode) {
                                    ...
                                    case c.KEY_CODE.UP_ARROW:
                                        s(e, l.menuContentEl, l, -1);
                                        break;
                                    case c.KEY_CODE.DOWN_ARROW:
                                        s(e, l.menuContentEl, l, 1)
                                }
                            })
                        }), l.menuContentEl.on("click", function (e) {
                            function t() {
                                n.$apply(function () {
                                    l.mdMenuCtrl.close()
                                })
                            ...
                            var o = e.target;
                            do if (o && o.hasAttribute("ng-click")) {
                                o.hasAttribute("disabled") || t();
                                break
                            } while ((o = o.parentNode) && o != l.menuContentEl)
                        });
                        var e = l.menuContentEl[0].querySelector("[md-menu-focus-target]");
                        e || (e = l.menuContentEl[0].firstElementChild.firstElementChild), e.focus()
                    }

                    return m(l), a.inherit(l.menuContentEl, l.target), u(), l.disableParentScroll && (l.restoreScroll = i.disableScrollAround(l.element)), d(h, 75, !1), l.backdrop && (a.inherit(l.backdrop, l.parent), l.parent.append(l.backdrop)), f(), i.transitionEndPromise(r, {timeout: 350})
                }

                function s(e, t, n, o) {
                    for (var r = i.getClosest(e.target, "MD-MENU-ITEM"), a = i.nodesToArray(t[0].children), d = a.indexOf(r), c = d + o; c >= 0 && c < a.length; c += o) {
                        var l = a[c].firstElementChild || a[c], m = u(l);
                        if (m)break
                    }
                }

                function u(e) {
                    return e && -1 != e.getAttribute("tabindex") ? (e.focus(), l[0].activeElement == e ? !0 : !1) : void 0
                }

                function f(e, r, a) {
                    return a.isRemoved = !0, r.addClass("md-leave").removeClass("md-clickable"), t.element(o).off("resize", a.resizeFn), t.element(o).off("orientationchange", a.resizeFn), a.resizeFn = n, i.transitionEndPromise(r, {timeout: 350}).then(function () {
                        r.removeClass("md-active"), a.backdrop && a.backdrop.remove(), r[0].parentNode === a.parent[0] && a.parent[0].removeChild(r[0]), a.restoreScroll && a.restoreScroll()
                    })
                }

                function p(e, t) {
                    function n(e) {
                        e.top = Math.max(Math.min(e.top, h.bottom - d.offsetHeight), h.top), e.left = Math.max(Math.min(e.left, h.right - d.offsetWidth), h.left)
                    }

                    if (!t.isRemoved) {
                        var o, i, a, d = e[0], l = e[0].firstElementChild, m = l.getBoundingClientRect(), s = t.parent[0], u = s.getBoundingClientRect(), f = t.target[0].querySelector("[md-menu-origin]") || t.target[0], p = f.getBoundingClientRect(), h = {
                            left: u.left + r,
                            top: u.top + r,
                            bottom: u.bottom - r,
                            right: u.right - r
                        }, b = t.mdMenuCtrl.positionMode();
                        ("target" == b.top || "target" == b.left || "target-right" == b.left) && (o = l.firstElementChild.firstElementChild || l.firstElementChild, o = o.querySelector("[md-menu-align-target]") || o, i = o.getBoundingClientRect(), a = {
                        ...
                        switch (b.top) {
                            case"target":
                                g.top = a.top + p.top - i.top;
                                break;
                            default:
                                throw new Error('Invalid target mode "' + b.top + '" specified for md-menu on Y axis.')
                        }
                        switch (b.left) {
                            case"target":
                                g.left = a.left + p.left - i.left, E += "left";
                                break;
                            case"target-right":
                                g.left = p.right - m.width + (m.right - i.right), E += "right";
                                break;
                            default:
                                throw new Error('Invalid target mode "' + b.left + '" specified for md-menu on X axis.')
                        }
                        var v = t.mdMenuCtrl.offsets();
                        g.top += v.top, g.left += v.left, n(g), e.css({
                            top: g.top + "px",
                            left: g.left + "px"
                        }), d.style[c.CSS.TRANSFORM_ORIGIN] = E, t.alreadyOpen || (d.style[c.CSS.TRANSFORM] = "scale(" + Math.min(p.width / d.offsetWidth, 1) + "," + Math.min(p.height / d.offsetHeight, 1) + ")")
                    }
                }
            ...
            var r = 8;
            return o.$inject = ["$$rAF", "$window", "$mdUtil", "$mdTheming", "$timeout", "$mdConstant", "$document"], e("$mdMenu").setDefaults({
                methods: ["target"],
                options: o
            })
        }
        ...
        function e(e, t) {
            ...
            function o(n, o, i) {
                t(o);
                var a = o[0], d = i.mdDiameter || 48, c = d / 48;
                a.style[e.CSS.TRANSFORM] = "scale(" + c + ")", i.$observe("value", function (e) {
                    var t = r(e);
        ...
        t.module("material.components.progressCircular", ["material.core"]).directive("mdProgressCircular", e), e.$inject = ["$mdConstant", "$mdTheming"]
    }(), function () {
        function e(e, o, r) {
            function i(e, t, n) {
            ...
            function a(i, a, c) {
                r(a);
                var l = a[0].querySelector(".md-bar1").style, m = a[0].querySelector(".md-bar2").style, s = t.element(a[0].querySelector(".md-container"));
                c.$observe("value", function (e) {
                    if ("query" != c.mdMode) {
                        var t = d(e);
                        a.attr("aria-valuenow", t), m[o.CSS.TRANSFORM] = n[t]
                    }
                }), c.$observe("mdBufferValue", function (e) {
                    l[o.CSS.TRANSFORM] = n[d(e)]
                }), e(function () {
                    s.addClass("md-ready")
                })
            }
        ...
        t.module("material.components.progressLinear", ["material.core"]).directive("mdProgressLinear", e), e.$inject = ["$$rAF", "$mdConstant", "$mdTheming"];
        var n = function () {
            function e(e) {
        ...
        function e(e, n, o, r) {
            function i(i, a, d, c) {
                ...
                function m(o) {
                    ...
                    switch (r) {
                        ...
                        case n.KEY_CODE.UP_ARROW:
                            o.preventDefault(), s.selectPrevious(), l();
                            break;
                        case n.KEY_CODE.RIGHT_ARROW:
                        case n.KEY_CODE.DOWN_ARROW:
                            o.preventDefault(), s.selectNext(), l();
                            break;
                ...
                o(a);
                var s = c[0], u = c[1] || e.fakeNgModel();
                s.init(u), i.mouseActive = !1, a.attr({
                    role: "radiogroup",
                    tabIndex: a.attr("tabindex") || "0"
                }).on("keydown", m).on("mousedown", function (e) {
                    i.mouseActive = !0, r(function () {
                        i.mouseActive = !1
                    }, 100)
                }).on("focus", function () {
                    i.mouseActive === !1 && s.$element.addClass("md-focused")
                }).on("blur", function () {
        ...
        function n(e, t, n) {
            function o(o, i, a, d) {
                ...
                function l() {
                    ...
                    e !== s && (s = e, i.attr("aria-checked", e), e ? (i.addClass(r), d.setActiveDescendant(i.attr("id"))) : i.removeClass(r))
                }
                ...
                var s;
                n(i), m(i, o), d.add(l), a.$observe("value", l), i.on("click", c).on("$destroy", function () {
                    d.remove(l)
                })
            }
        ...
        function e(e, o, r, i, a, d, c) {
            function l(a, l) {
                var m = a.find("md-select-label").remove();
                if (m.length) {
                    if (!m[0].firstElementChild) {
                        var s = t.element("<span>");
                        s.append(m.contents()), m.append(s)
                    }
                } else m = t.element("<md-select-label><span></span></md-select-label>");
                if (m.append('<span class="md-select-icon" aria-hidden="true"></span>'), m.addClass("md-select-label"), m[0].hasAttribute("id") || m.attr("id", "select_label_" + o.nextUid()), a.find("md-content").length || a.append(t.element("<md-content>").append(a.contents())), l.mdOnOpen && a.find("md-content").prepend(t.element("<md-progress-circular>").attr("md-mode", "indeterminate").attr("ng-hide", "$$loadingAsyncDone").wrap("<div>").parent()), l.name) {
                    var u = t.element('<select class="md-visually-hidden">');
                    u.attr({name: "." + l.name, "ng-model": l.ngModel, "aria-hidden": "true", tabindex: "-1"});
                    var f = a.find("md-option");
                ...
                var p = '<div class="md-select-menu-container"><md-select-menu ' + (t.isDefined(l.multiple) ? "multiple" : "") + ">" + a.html() + "</md-select-menu></div>";
                return a.empty().append(m), l.tabindex = l.tabindex || "0", function (a, l, m, s) {
                    function u() {
                        var e = l.attr("placeholder");
                        e || (e = l.find("md-select-label").text()), i.expect(l, "aria-label", e)
                    }

                    function f() {
                        M && (A = A || M.find("md-select-menu").controller("mdSelectMenu"), C.setLabelText(A.selectedLabels()))
                    }

                    function h() {
                        M = t.element(p);
                        var e = M.find("md-select-menu");
                        e.data("$ngModelController", T), e.data("$mdSelectController", C), $ = a.$new(), M = d(M)($), A = M.find("md-select-menu").controller("mdSelectMenu")
                    }

                    function b(e) {
                        var n = [32, 13, 38, 40];
                        if (-1 != n.indexOf(e.keyCode))e.preventDefault(), g(e); else if (e.keyCode <= 90 && e.keyCode >= 31) {
                            e.preventDefault();
                            var o = A.optNodeForKeyboardSearch(e);
                            if (!o)return;
                            var r = t.element(o).controller("mdOption");
                            A.isMultiple || A.deselect(Object.keys(A.selected)[0]), A.select(r.hashKey, r.value), A.refreshViewValue(), T.$render()
                        }
                    }
                    ...
                    function g() {
                        a.$evalAsync(function () {
                            E = !0, e.show({
                                ...
                                target: l[0],
                                hasBackdrop: !0,
                                loadingAsync: m.mdOnOpen ? a.$eval(m.mdOnOpen) || !0 : !1
                            }).then(function (e) {
                                E = !1
                            })
                        })
                    ...
                    var E, v, M, $, A, C = s[0], T = s[1], y = s[2], k = l.find("md-select-label"), w = 0 !== k.text().length;
                    if (h(), r(l), m.name && y) {
                        var x = l.parent()[0].querySelector('select[name=".' + m.name + '"]');
                        y.$removeControl(t.element(x).controller())
                    }
                    var N = T.$render;
                    T.$render = function () {
                        N(), f()
                        ...
                        if (!w) {
                            C.setIsPlaceholder(!e), e = e || m.placeholder || "";
                            var t = w ? k : k.children().eq(0);
                            t.text(e)
                        }
                    }, C.setIsPlaceholder = function (e) {
                        e ? k.addClass("md-placeholder") : k.removeClass("md-placeholder")
                    ...
                    var _;
                    m.$observe("ngMultiple", function (e) {
                        _ && _();
                        var t = c(e);
                        _ = a.$watch(function () {
                            return t(a)
                        }, function (e, t) {
                            (e !== n || t !== n) && (e ? l.attr("multiple", "multiple") : l.removeAttr("multiple"), M && (A.setMultiple(e), N = T.$render, T.$render = function () {
                                N(), f()
                            }, A.refreshViewValue(), T.$render()))
                        })
                    }), m.$observe("disabled", function (e) {
                        "string" == typeof e && (e = !0), (v === n || v !== e) && (v = e, e ? (l.attr({
                            tabindex: -1,
                            "aria-disabled": "true"
                        }), l.off("click", g), l.off("keydown", b)) : (l.attr({
                            tabindex: m.tabindex,
                            "aria-disabled": "false"
                        }), l.on("click", g), l.on("keydown", b)))
                    }), m.disabled || m.ngDisabled || (l.attr({
                        tabindex: m.tabindex,
                        "aria-disabled": "false"
                    }), l.on("click", g), l.on("keydown", b));
                    var H = {role: "combobox", "aria-expanded": "false"};
                    l[0].hasAttribute("id") || (H.id = "select_" + o.nextUid()), l.attr(H), a.$on("$destroy", function () {
                        E ? e.cancel().then(function () {
                            M.remove()
                        }) : M.remove()
                    })
                }
            ...
            return {
                restrict: "E", require: ["mdSelect", "ngModel", "?^form"], compile: l, controller: function () {
                }
            }
        }
        ...
        function o(e, o, r) {
            function i(e, n, i, a) {
                function d() {
                    n.attr({
                        ...
                        role: "listbox",
                        "aria-multiselectable": m.isMultiple ? "true" : "false"
                    })
                }
                ...
                function l(n) {
                    ...
                    if (r && i) {
                        var a = m.hashGetter(i.value), d = t.isDefined(m.selected[a]);
                        e.$apply(function () {
                            m.isMultiple ? d ? m.deselect(a) : m.select(a, i.value) : d || (m.deselect(Object.keys(m.selected)[0]), m.select(a, i.value)), m.refreshViewValue()
                        })
                    }
                }

                var m = a[0], s = a[1];
                r(n), n.on("click", l), n.on("keypress", c), s && m.init(s), d()
            }
            ...
            function a(r, i, a) {
                function d() {
                    ...
                    if (t.isArray(e)) {
                        var n = Object.keys(m.selected), o = e.map(m.hashGetter), r = n.filter(function (e) {
                            return -1 === o.indexOf(e)
                        });
                        r.forEach(m.deselect), o.forEach(function (t, n) {
                            m.select(t, e[n])
                        })
                    }
                }
                ...
                var m = this;
                m.isMultiple = t.isDefined(i.multiple), m.selected = {}, m.options = {}, r.$watch(function () {
                    return m.options
                }, function () {
                    m.ngModel.$render()
                }, !0);
                ...
                m.setMultiple = function (e) {
                    ...
                    var o = m.ngModel;
                    m.isMultiple = e, s && s(), m.isMultiple ? (o.$validators["md-multiple"] = n, o.$render = d, r.$watchCollection(i.ngModel, function (e) {
                        n(e) && d(e)
                    })) : (delete o.$validators["md-multiple"], o.$render = l)
                };
                var u, f, p, h = "", b = 300;
                m.optNodeForKeyboardSearch = function (e) {
                    u && clearTimeout(u), u = setTimeout(function () {
                        u = n, h = "", p = n, f = n
                    }, b), h += String.fromCharCode(e.keyCode);
                    var o = new RegExp("^" + h, "i");
                    f || (f = a.find("md-option"), p = new Array(f.length), t.forEach(f, function (e, t) {
                        p[t] = e.textContent.trim()
                    }));
                    for (var r = 0; r < p.length; ++r)if (o.test(p[r]))return f[r]
                }, m.init = function (n) {
                    if (m.ngModel = n, n.$options && n.$options.trackBy) {
                    ...
                    m.options[e] = n, t.isDefined(m.selected[e]) && (m.select(e, n.value), m.refreshViewValue())
                }, m.removeOption = function (e) {
                    delete m.options[e]
                }, m.refreshViewValue = function () {
                    var e, t = [];
                    for (var n in m.selected)t.push((e = m.options[n]) ? e.value : m.selected[n]);
                    m.ngModel.$setViewValue(m.isMultiple ? t : t[0])
                }
            }
        ...
        function r(e, n) {
            ...
            function r(o, r, i, a) {
                function d(e, t) {
                    var n = m.hashGetter(t, o), r = m.hashGetter(e, o);
                    l.hashKey = r, l.value = e, m.removeOption(n, l), m.addOption(r, l)
                }
                ...
                t.isDefined(i.ngValue) ? o.$watch(i.ngValue, d) : t.isDefined(i.value) ? d(i.value) : o.$watch(function () {
                    return r.text()
                }, d), o.$$postDigest(function () {
                    i.$observe("selected", function (e) {
                        t.isDefined(e) && (e ? (m.isMultiple || m.deselect(Object.keys(m.selected)[0]), m.select(l.hashKey, l.value)) : m.deselect(l.hashKey), m.refreshViewValue(), m.ngModel.$render())
                    })
        ...
        function a(e) {
            function o(e, o, a, c, l, m, s) {
                function u(n, r, i) {
                    function d() {
                        i.target.attr("aria-expanded", "true")
                    }

                    function u() {
                        function t(e) {
                            var t = c.nodesToArray(f), n = t.indexOf(i.focusedNode);
                            -1 === n ? n = 0 : "next" === e && n < t.length - 1 ? n++ : "prev" === e && n > 0 && n--;
                            var o = i.focusedNode = t[n];
                            o && o.focus()
                        }
                        ...
                        function l() {
                            m.isMultiple || (i.restoreFocus = !0, n.$evalAsync(function () {
                            ...
                            r.addClass("md-clickable"), i.backdrop && i.backdrop.on("click", function (t) {
                                ...
                                switch (t.keyCode) {
                                    ...
                                    case o.KEY_CODE.ESCAPE:
                                        t.preventDefault(), i.restoreFocus = !0, n.$apply(e.cancel)
                                }
                                ...
                                switch (e.keyCode) {
                                    ...
                                    default:
                                        if (e.keyCode >= 31 && e.keyCode <= 90) {
                                            var t = i.selectEl.controller("mdSelectMenu").optNodeForKeyboardSearch(e);
                                            t && t.focus()
                                        }
                                }
                            }), i.selectEl.on("click", l), i.selectEl.on("keydown", function (e) {
                                (32 == e.keyCode || 13 == e.keyCode) && l()
                            })
                        }
                    }
                    ...
                    t.extend(i, {
                        ...
                        backdrop: i.hasBackdrop && t.element('<md-backdrop class="md-select-backdrop md-click-catcher">')
                    }), i.resizeFn = function () {
                        a(function () {
                            a(function () {
                                p(n, r, i)
                    ...
                    }, t.element(s).on("resize", i.resizeFn), t.element(s).on("orientationchange", i.resizeFn), d(), r.removeClass("md-leave");
                    ...
                    }) : i.loadingAsync && (n.$$loadingAsyncDone = !0), i.disableParentScroll && !c.getClosest(i.target, "MD-DIALOG") ? i.restoreScroll = c.disableScrollAround(i.element) : i.disableParentScroll = !1, m(u, 75, !1), i.backdrop && (l.inherit(i.backdrop, i.parent), i.parent.append(i.backdrop)), i.parent.append(r), a(function () {
                        a(function () {
                            i.isRemoved || p(n, r, i)
                        })
                    }), c.transitionEndPromise(i.selectEl, {timeout: 350})
                }

                function f(e, o, r) {
                    r.isRemoved = !0, o.addClass("md-leave").removeClass("md-clickable"), r.target.attr("aria-expanded", "false"), t.element(s).off("resize", r.resizeFn), t.element(s).off("orientationchange", r.resizefn), r.resizeFn = n;
                    var i = r.selectEl.controller("mdSelect");
                    return i && i.setLabelText(r.selectEl.controller("mdSelectMenu").selectedLabels()), c.transitionEndPromise(o, {timeout: 350}).then(function () {
                        o.removeClass("md-active"), r.backdrop && r.backdrop.remove(), o[0].parentNode === r.parent[0] && r.parent[0].removeChild(o[0]), r.disableParentScroll && r.restoreScroll(), r.restoreFocus && r.target.focus(), i && i.triggerClose()
                    })
                }

                function p(e, t, n) {
                    var l, m = t[0], u = n.target[0].firstElementChild.firstElementChild, f = n.parent[0], p = n.selectEl[0], h = n.contentEl[0], b = f.getBoundingClientRect(), g = u.getBoundingClientRect(), E = !1, v = {
                        left: b.left + d,
                        top: d,
                        bottom: b.height - d,
                    ...
                    }, $ = b.width - 2 * d, A = h.scrollHeight > h.offsetHeight, C = p.querySelector("md-option[selected]"), T = p.getElementsByTagName("md-option"), y = p.getElementsByTagName("md-optgroup");
                    l = C ? C : y.length ? y[0] : T.length ? T[0] : h.firstElementChild || h, h.offsetWidth > $ && (h.style["max-width"] = $ + "px"), E && (h.style["min-width"] = g.width + "px"), A && p.classList.add("md-overflow");
                    var k = p.getBoundingClientRect(), w = i(l);
                    if (l) {
                        var x = s.getComputedStyle(l);
                        w.paddingLeft = parseInt(x.paddingLeft, 10) || 0, w.paddingRight = parseInt(x.paddingRight, 10) || 0
                    }
                    var N = l;
                    if ("MD-OPTGROUP" === (N.tagName || "").toUpperCase() && (N = T[0] || h.firstElementChild || h), A) {
                        var _ = h.offsetHeight / 2;
                        h.scrollTop = w.top + w.height / 2 - _, M.top < _ ? h.scrollTop = Math.min(w.top, h.scrollTop + _ - M.top) : M.bottom < _ && (h.scrollTop = Math.max(w.top + w.height - k.height, h.scrollTop - _ + M.bottom))
                    }
                    var H, S, I;
                    E ? (H = g.left, S = g.top + g.height, I = "50% 0", S + k.height > v.bottom && (S = g.top - k.height, I = "50% 100%")) : (H = g.left + w.left - w.paddingLeft, S = Math.floor(g.top + g.height / 2 - w.height / 2 - w.top + h.scrollTop), I = w.left + g.width / 2 + "px " + (w.top + w.height / 2 - h.scrollTop) + "px 0px", m.style.minWidth = g.width + w.paddingLeft + w.paddingRight + "px");
                    var O = m.getBoundingClientRect();
                    m.style.left = r(v.left, H, v.right - O.width) + "px", m.style.top = r(v.top, S, v.bottom - O.height) + "px", p.style[o.CSS.TRANSFORM_ORIGIN] = I, p.style[o.CSS.TRANSFORM] = "scale(" + Math.min(g.width / k.width, 1) + "," + Math.min(g.height / k.height, 1) + ")", a(function () {
                        t.addClass("md-active"), p.style[o.CSS.TRANSFORM] = "", N && (n.focusedNode = N, N.focus())
                    })
                }

                return {parent: "body", onShow: u, onRemove: f, hasBackdrop: !0, disableParentScroll: !0, themable: !0}
            }
            ...
            return o.$inject = ["$mdSelect", "$mdConstant", "$$rAF", "$mdUtil", "$mdTheming", "$timeout", "$window"], e("$mdSelect").setDefaults({
                methods: ["target"],
                options: o
            })
        }
        ...
        function r(e, o, r, i, a, d, c, l, m, s) {
            function u(u, f, p, h) {
                function b(e, t) {
                    u.isLockedOpen = e, e === t ? f.toggleClass("md-locked-open", !!e) : o[e ? "addClass" : "removeClass"](f, "md-locked-open"), w.toggleClass("md-locked-open", !!e)
                }

                function g(e) {
                    var t = f.parent();
                    t[e ? "on" : "off"]("keydown", M), w[e ? "on" : "off"]("click", $), e && (C = s[0].activeElement);
                    var n = h.focusElement();
                    return E(e), T = m.all([e ? o.enter(w, t) : o.leave(w), o[e ? "removeClass" : "addClass"](f, "md-closed")]).then(function () {
                        u.isOpen && n && n.focus()
                    })
                }
                ...
                function E(e) {
                    var o = f.parent();
                    e ? (A = o.css("overflow"), o.css("overflow", "hidden")) : t.isDefined(A) && (o.css("overflow", A), A = n)
                }

                function v(t) {
                    if (u.isOpen == t)return m.when(!0);
                    var n = m.defer();
                    return u.isOpen = t, e(function () {
                        T.then(function (e) {
                            u.isOpen || (C && C.focus(), C = null), n.resolve(e)
                        })
                    }, 0, !1), n.promise
                }

                function M(e) {
                    var t = e.keyCode === d.KEY_CODE.ESCAPE;
                    return t ? $(e) : m.when(!0)
                }
                ...
                var A, C = null, T = m.when(!0), y = r(p.mdIsLockedOpen), k = function () {
                    return y(u.$parent, {
                        $media: function (e) {
                            return i.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."), a(e)
                        }, $mdMedia: a
                    })
                }, w = c('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(u);
                f.on("$destroy", h.destroy), l.inherit(w, f), u.$watch(k, b), u.$watch("isOpen", g), h.$toggleOpen = v, h.focusElement(h.focusElement() || f)
            }
        ...
        function i(e, n, o, r, i) {
            ...
            d.isOpen = function () {
                return !!e.isOpen
            }, d.isLockedOpen = function () {
                return !!e.isLockedOpen
            }, d.open = function () {
                return d.$toggleOpen(!0)
            }, d.close = function () {
                return d.$toggleOpen(!1)
            }, d.toggle = function () {
                return d.$toggleOpen(!e.isOpen)
            }, d.focusElement = function (e) {
                return t.isDefined(e) && (a = e), a
            }, d.$toggleOpen = function () {
                return i.when(e.isOpen)
            }, d.destroy = r.register(d, o.mdComponentId)
        }
        ...
        function e(e, n, o, r, i, a, d, c) {
            ...
            function m(o, l, m, s) {
                ...
                function f(e) {
                    W = parseFloat(e), l.attr("aria-valuemin", e), u()
                }

                function p(e) {
                    G = parseFloat(e), l.attr("aria-valuemax", e), u()
                }
                ...
                function g() {
                    if (t.isDefined(m.mdDiscrete)) {
                        var e = Math.floor((G - W) / X);
                        if (!Q) {
                            var o = n.getComputedStyle(U[0]);
                            Q = t.element('<canvas style="position:absolute;">'), Z = Q[0].getContext("2d"), Z.fillStyle = o.backgroundColor || "black", U.append(Q)
                        }
                        var r = v();
                        Q[0].width = r.width, Q[0].height = r.height;
                        for (var i, a = 0; e >= a; a++)i = Math.floor(r.width * (a / e)), Z.fillRect(i - 1, 0, 2, r.height)
                    }
                }
                ...
                function $(e) {
                    s.$setViewValue(C(T(e)))
                }

                function A() {
                    isNaN(s.$viewValue) && (s.$viewValue = s.$modelValue);
                    var e = (s.$viewValue - W) / (G - W);
                    o.modelValue = s.$viewValue, l.attr("aria-valuenow", s.$viewValue), y(e), j.text(s.$viewValue)
                }

                function C(e) {
                    return t.isNumber(e) ? Math.max(W, Math.min(G, e)) : void 0
                }
                ...
                function y(e) {
                    V.css("width", 100 * e + "%"), B.css("left", 100 * e + "%"), l.toggleClass("md-min", 0 === e)
                }

                function k(e) {
                    if (!P()) {
                        l.addClass("active"), l[0].focus(), E();
                        var t = D(O(e.pointer.x)), n = C(T(t));
                        o.$apply(function () {
                            $(n), y(R(n))
                        })
                    }
                ...
                function x(e) {
                    P() || (ee = !0, e.stopPropagation(), l.addClass("dragging"), H(e))
                }

                function N(e) {
                    ee && (e.stopPropagation(), H(e))
                }
                ...
                function H(e) {
                    te ? I(e.pointer.x) : S(e.pointer.x)
                }
                ...
                var L = m.ngDisabled && c(m.ngDisabled), P = L ? function () {
                    return L(o.$parent)
                } : t.noop, F = t.element(l[0].querySelector(".md-thumb")), j = t.element(l[0].querySelector(".md-thumb-text")), B = F.parent(), q = t.element(l[0].querySelector(".md-track-container")), V = t.element(l[0].querySelector(".md-track-fill")), U = t.element(l[0].querySelector(".md-track-ticks")), Y = r.throttle(E, 5e3);
                t.isDefined(m.min) ? m.$observe("min", f) : f(0), t.isDefined(m.max) ? m.$observe("max", p) : p(100), t.isDefined(m.step) ? m.$observe("step", h) : h(1);
                var K = t.noop;
                m.ngDisabled && (K = o.$parent.$watch(m.ngDisabled, b)), d.register(l, "drag"), l.on("keydown", M).on("$md.pressdown", k).on("$md.pressup", w).on("$md.dragstart", x).on("$md.drag", N).on("$md.dragend", _), setTimeout(u);
                var z = e.throttle(u);
                t.element(n).on("resize", z), o.$on("$destroy", function () {
                    t.element(n).off("resize", z), K()
                }), s.$render = A, s.$viewChangeListeners.push(A), s.$formatters.push(C), s.$formatters.push(T);
                var W, G, X, Q, Z, J = {};
                E();
        ...
        t.module("material.components.slider", ["material.core"]).directive("mdSlider", e), e.$inject = ["$$rAF", "$window", "$mdAria", "$mdUtil", "$mdConstant", "$mdTheming", "$mdGesture", "$parse"]
    }(), function () {
        function e(e, n, o) {
            return {
                restrict: "E",
                ...
                compile: function (r, i, a) {
                    return function (r, i, d) {
                        ...
                        a(r, function (e) {
                            c(i).append(e)
                        }), i.hasClass("md-no-sticky") || a(r, function (o) {
                            var a = n(t.element(l))(r);
                            c(a).append(o), e(r, i, a)
                        })
                    }
                }
            }
        ...
        t.module("material.components.subheader", ["material.core", "material.components.sticky"]).directive("mdSubheader", e), e.$inject = ["$mdSticky", "$compile", "$mdTheming"]
    }(), function () {
        function e(e, o, r, i, a) {
            function d(e) {
                function t(e, t) {
                    t.addClass("md-sticky-clone"), t.css("top", b + "px");
                    var n = {element: e, clone: t};
                    return h.items.push(n), f.parent().prepend(n.clone), p(), function () {
                        h.items.forEach(function (t, n) {
                            t.element[0] === e[0] && (h.items.splice(n, 1), t.clone.remove())
                        }), p()
                    }
                }

                function r() {
                    h.items.forEach(d), h.items = h.items.sort(function (e, t) {
                        return e.top < t.top ? -1 : 1
                    });
                    for (var e, t = f.prop("scrollTop"), n = h.items.length - 1; n >= 0; n--)if (t > h.items[n].top) {
                        e = h.items[n];
                        break
                    }
                    m(e)
                ...
                function d(e) {
                    ...
                    e.height = e.element.prop("offsetHeight"), e.clone.css("margin-left", e.left + "px"), a.floatingScrollbars() && e.clone.css("margin-right", "0")
                }

                function c() {
                    var e = f.prop("scrollTop"), t = e > (c.prevScrollTop || 0);
                    c.prevScrollTop = e, 0 === e ? m(null) : t && h.next ? h.next.top - e <= 0 ? m(h.next) : h.current && (h.next.top - e <= h.next.height ? u(h.current, h.next.top - h.next.height - e) : u(h.current, null)) : !t && h.current && (e < h.current.top && m(h.prev), h.current && h.next && (e >= h.next.top - h.current.height ? u(h.current, h.next.top - e - h.current.height) : u(h.current, null)))
                }

                function m(e) {
                    if (h.current !== e) {
                        h.current && (u(h.current, null), s(h.current, null)), e && s(e, "active"), h.current = e;
                        var t = h.items.indexOf(e);
                        h.next = h.items[t + 1], h.prev = h.items[t - 1], s(h.next, "next"), s(h.prev, "prev")
                    }
                }
                ...
                var f = e.$element, p = i.throttle(r);
                l(f), f.on("$scrollstart", p), f.on("$scroll", c);
                var h, b = f.prop("offsetTop");
                return h = {prev: null, current: null, next: null, items: [], add: t, refreshElements: r}
            }
            ...
            function l(e) {
                function t() {
                    +a.now() - o > r ? (n = !1, e.triggerHandler("$scrollend")) : (e.triggerHandler("$scroll"), i(t))
                }

                var n, o, r = 200;
                e.on("scroll touchmove", function () {
                    n || (n = !0, i(t), e.triggerHandler("$scrollstart")), e.triggerHandler("$scroll"), o = +a.now()
                })
            }
            ...
            return function (e, t, n) {
                ...
                if (o)if (m)t.css({position: m, top: 0, "z-index": 2}); else {
                    var r = o.$element.data("$$sticky");
                    r || (r = d(o), o.$element.data("$$sticky", r));
        ...
        t.module("material.components.sticky", ["material.core", "material.components.content"]).factory("$mdSticky", e), e.$inject = ["$document", "$mdConstant", "$compile", "$$rAF", "$mdUtil"]
    }(), function () {
        function e(e) {
            function t(e) {
                function t(t, r, i) {
        ...
        function e(e, n, o, r, i, a, d, c) {
            function l(e, n) {
                var r = m.compile(e, n);
                return e.addClass("md-dragging"), function (e, n, l, m) {
                    function s(t) {
                        h(e) || (t.stopPropagation(), n.addClass("md-dragging"), E = {width: b.prop("offsetWidth")}, n.removeClass("transition"))
                    }

                    function u(e) {
                        if (E) {
                            e.stopPropagation(), e.srcEvent && e.srcEvent.preventDefault();
                            var t = e.pointer.distanceX / E.width, n = m.$viewValue ? 1 + t : t;
                            n = Math.max(0, Math.min(1, n)), b.css(i.CSS.TRANSFORM, "translate3d(" + 100 * n + "%,0,0)"), E.translate = n
                        }
                    }

                    function f(e) {
                        if (E) {
                            e.stopPropagation(), n.removeClass("md-dragging"), b.css(i.CSS.TRANSFORM, "");
                            var t = m.$viewValue ? E.translate < .5 : E.translate > .5;
                            t && p(!m.$viewValue), E = null
                        }
                    }
                    ...
                    m = m || o.fakeNgModel();
                    var h = a(l.ngDisabled), b = t.element(n[0].querySelector(".md-thumb-container")), g = t.element(n[0].querySelector(".md-container"));
                    d(function () {
                        n.removeClass("md-dragging")
                    }), r(e, n, l, m), t.isDefined(l.ngDisabled) && e.$watch(h, function (e) {
                        n.attr("tabindex", e ? -1 : 0)
                    }), c.register(g, "drag"), g.on("$md.dragstart", s).on("$md.drag", u).on("$md.dragend", f);
                    var E
                }
            }
        ...
        t.module("material.components.switch", ["material.core", "material.components.checkbox"]).directive("mdSwitch", e), e.$inject = ["mdCheckboxDirective", "$mdTheming", "$mdUtil", "$document", "$mdConstant", "$parse", "$$rAF", "$mdGesture"]
    }(), function () {
        ...
        function n(e) {
            function t(e, t, o, r) {
                function i(i, a, c) {
                    return a = r.extractElementByName(a, "md-toast"), n = c.content, a.addClass(c.position.split(" ").map(function (e) {
                        return "md-" + e
                    }).join(" ")), c.parent.addClass(d(c.position)), c.onSwipe = function (t, n) {
                        a.addClass("md-" + t.type.replace("$md.", "")), e(o.cancel)
                    }, a.on("$md.swipeleft $md.swiperight", c.onSwipe), t.enter(a, c.parent)
                }

                function a(e, n, o) {
                    return n.off("$md.swipeleft $md.swiperight", o.onSwipe), o.parent.removeClass(d(o.position)), t.leave(n)
                }
                ...
                return {onShow: i, onRemove: a, position: "bottom left", themable: !0, hideDelay: 3e3}
            }
        ...
        t.module("material.components.toast", ["material.core", "material.components.button"]).directive("mdToast", e).provider("$mdToast", n), n.$inject = ["$$interimElementProvider"]
    }(), function () {
        function e(e, n, o, r, i, a) {
            return {
                restrict: "E", controller: t.noop, link: function (d, c, l) {
                    function m() {
                        function t(t, n) {
                            c.parent()[0] === n.parent()[0] && (u && u.off("scroll", b), n.on("scroll", b), n.attr("scroll-shrink", "true"), u = n, e(r))
                        }

                        function r() {
                            s = c.prop("offsetHeight");
                            var e = -s * h + "px";
                            u.css("margin-top", e), u.css("margin-bottom", e), m()
                        }

                        function m(e) {
                            var t = e ? e.target.scrollTop : p;
                            g(), f = Math.min(s / h, Math.max(0, f + t - p)), c.css(n.CSS.TRANSFORM, "translate3d(0," + -f * h + "px,0)"), u.css(n.CSS.TRANSFORM, "translate3d(0," + (s - f) * h + "px,0)"), p = t, c.hasClass("md-whiteframe-z1") ? f || a(function () {
                                i.removeClass(c, "md-whiteframe-z1")
                            }) : f && a(function () {
                                i.addClass(c, "md-whiteframe-z1")
                            })
                        }

                        var s, u, f = 0, p = 0, h = l.mdShrinkSpeedFactor || .5, b = e.throttle(m), g = o.debounce(r, 5e3);
                        d.$on("$mdContentLoaded", t)
                    }

                    r(c), t.isDefined(l.mdScrollShrink) && m()
                }
            }
        }

        t.module("material.components.toolbar", ["material.core", "material.components.content"]).directive("mdToolbar", e), e.$inject = ["$$rAF", "$mdConstant", "$mdUtil", "$mdTheming", "$animate", "$timeout"]
    }(), function () {
        function e(e, n, o, r, i, a, d, c, l) {
            function m(m, f, p) {
                function h() {
                    b(), v(), C(), g(), E()
                }
                ...
                function b() {
                    t.isDefined(p.mdDelay) || (m.delay = s)
                }

                function g() {
                    m.$on("$destroy", function () {
                        m.visible = !1, f.remove(), t.element(n).off("resize", O)
                    }), m.$watch("visible", function (e) {
                        e ? y() : k()
                    })
                }

                function E() {
                    x.attr("aria-label") || x.text().trim() || x.attr("aria-label", f.text().trim())
                }
                ...
                function M() {
                    for (var e = f.parent(); e && "none" == n.getComputedStyle(e[0])["pointer-events"];)e = e.parent();
                    return e
                }

                function $() {
                    for (var e = f.parent()[0]; e && e !== d[0] && e !== document.body;)e = e.parentNode;
                    return e
                }

                function A(e, o) {
                    var r = n.getComputedStyle(f[0]);
                    return t.isDefined(r[e]) && r[e] == o
                }

                function C() {
                    var e = !1, o = function () {
                        A("pointer-events", "none") || T(!0)
                    }, i = function () {
                        var t = m.hasOwnProperty("autohide") ? m.autohide : p.hasOwnProperty("mdAutohide");
                        (t || e || r[0].activeElement !== x[0]) && T(!1), e = !1
                    };
                    x.on("mousedown", function () {
                        e = !0
                    }), x.on("focus mouseenter touchstart", o), x.on("blur mouseleave touchend touchcancel", i), t.element(n).on("resize", O)
                }

                function T(t) {
                    T.value = !!t, T.queued || (t ? (T.queued = !0, e(function () {
                        m.visible = T.value, T.queued = !1
                    }, m.delay)) : e(function () {
                        m.visible = !1
                    }))
                }
                ...
                function y() {
                    return I.append(f), A("display", "none") ? (m.visible = !1, void f.detach()) : (w(), void t.forEach([f, N, _], function (e) {
                        c.addClass(e, "md-show")
                    }))
                }

                function k() {
                    l.all([c.removeClass(_, "md-show"), c.removeClass(N, "md-show"), c.removeClass(f, "md-show")]).then(function () {
                        m.visible || f.detach()
                    })
                }
                ...
                function w() {
                    function e() {
                        var e = "left" === H || "right" === H ? 2 * Math.sqrt(Math.pow(o.width, 2) + Math.pow(o.height / 2, 2)) : 2 * Math.sqrt(Math.pow(o.width / 2, 2) + Math.pow(o.height, 2)), t = "left" === H ? {
                            left: 100,
                            top: 50
                        } : "right" === H ? {left: 0, top: 50} : "top" === H ? {left: 50, top: 100} : {
                            left: 50,
                            top: 0
                        };
                        N.css({width: e + "px", height: e + "px", left: t.left + "%", top: t.top + "%"})
                    }

                    function t(e) {
                        var t = {left: e.left, top: e.top};
                        return t.left = Math.min(t.left, I.prop("scrollWidth") - o.width - u), t.left = Math.max(t.left, u), t.top = Math.min(t.top, I.prop("scrollHeight") - o.height - u), t.top = Math.max(t.top, u), t
                    }
                    ...
                    var o = i.offsetRect(f, I), r = i.offsetRect(x, I), a = n(H);
                    H ? a = t(a) : a.top > f.prop("offsetParent").scrollHeight - o.height - u && (a = t(n("top"))), f.css({
                        top: a.top + "px",
                        left: a.left + "px"
                    }), e()
                }
                ...
                a(f);
                var x = M(), N = t.element(f[0].getElementsByClassName("md-background")[0]), _ = t.element(f[0].getElementsByClassName("md-content")[0]), H = p.mdDirection, S = $(), I = t.element(S || document.body), O = o.throttle(function () {
                    m.visible && w()
                });
                return h()
            }
        ...
        function e(e, n, i, a, d, c, l, m, s, u) {
            function f() {
                i.initOptionalProperties(e, u, {searchText: null, selectedItem: null}), c(n), g(), d(function () {
                    v(), b(), h()
                })
            }
            ...
            function p() {
                function e() {
                    var e = Z.ul.getBoundingClientRect(), n = {};
                    e.right > i.right - r && (n.left = t.right - e.width + "px"), Z.$.ul.css(n)
                }

                if (!Z)return d(p, 0, !1);
                var t = Z.wrap.getBoundingClientRect(), n = Z.snap.getBoundingClientRect(), i = Z.root.getBoundingClientRect(), a = n.bottom - i.top, c = i.bottom - n.top, l = t.left - i.left, m = t.width, s = {
                    left: l + "px",
                    minWidth: m + "px",
                    maxWidth: Math.max(t.right - i.left, i.right - t.left) - r + "px"
                };
                a > c && i.height - t.bottom - r < o ? (s.top = "auto", s.bottom = c + "px", s.maxHeight = Math.min(o, t.top - i.top - r) + "px") : (s.top = a + "px", s.bottom = "auto", s.maxHeight = Math.min(o, i.bottom - t.bottom - r) + "px"), Z.$.ul.css(s), d(e, 0, !1)
            }

            function h() {
                Z.$.root.length && (c(Z.$.ul), Z.$.ul.detach(), Z.$.root.append(Z.$.ul), m.pin && m.pin(Z.$.ul, s))
            }

            function b() {
                e.autofocus && Z.input.focus()
            }
            ...
            function g() {
                ...
                u.$observe("disabled", function (e) {
                    ...
                    G.isRequired = null !== e
                }), e.$watch("searchText", n ? i.debounce(_, n) : _), x(k), e.$watch("selectedItem", w), t.element(l).on("resize", p), e.$on("$destroy", E)
            }

            function E() {
                t.element(l).off("resize", p), Z.$.ul.remove()
            }
            ...
            function v() {
                Z = {
                    main: n[0],
                    ul: n.find("ul")[0],
                    input: n.find("input")[0],
                    wrap: n.find("md-autocomplete-wrap")[0],
                    root: document.body
                }, Z.li = Z.ul.getElementsByTagName("li"), Z.snap = M(), Z.$ = $(Z)
            }

            function M() {
                for (var e = n; e.length; e = e.parent())if (t.isDefined(e.attr("md-autocomplete-snap")))return e[0];
                return Z.wrap
            }

            function $(e) {
                var n = {};
                for (var o in e)n[o] = t.element(e[o]);
                return n
            }

            function A(e, t) {
                !e && t && p(), e ? i.enableScrolling() : Z && d(function () {
                    i.disableScrollAround(Z.ul)
                }, 0, !1)
            }
            ...
            function k(t, n) {
                t && (e.searchText = D(t)), e.itemChange && t !== n && e.itemChange(R(t))
            }

            function w(e, t) {
                for (var n = 0; n < ne.length; ++n)ne[n](e, t)
            }
            ...
            function _(t, n) {
                G.index = L(), t !== n && t !== D(e.selectedItem) && (e.selectedItem = null, e.textChange && t !== n && e.textChange(R(e.selectedItem)), j() ? W() : (G.loading = !1, G.matches = [], G.hidden = P(), Y()))
            }
            ...
            function S() {
                oe = !0, t.isString(e.searchText) || (e.searchText = ""), e.minLength > 0 || (G.hidden = P(), G.hidden || W())
            }
            ...
            function I(e) {
                switch (e.keyCode) {
                    case a.KEY_CODE.DOWN_ARROW:
                        if (G.loading)return;
                        e.preventDefault(), G.index = Math.min(G.index + 1, G.matches.length - 1), z(), Y();
                        break;
                    case a.KEY_CODE.UP_ARROW:
                        if (G.loading)return;
                        e.preventDefault(), G.index = G.index < 0 ? G.matches.length - 1 : Math.max(0, G.index - 1), z(), Y();
                        break;
                    case a.KEY_CODE.TAB:
                    case a.KEY_CODE.ENTER:
                        if (G.hidden || G.loading || G.index < 0 || G.matches.length < 1)return;
                        e.preventDefault(), q(G.index);
                        break;
                    case a.KEY_CODE.ESCAPE:
                        G.matches = [], G.hidden = !0, G.index = L()
                }
            }
            ...
            function D(t) {
                return t && e.itemText ? e.itemText(R(t)) : t
            }

            function R(e) {
                if (e) {
                    var t = {};
                    return G.itemName && (t[G.itemName] = e), t
                }
            }
            ...
            function F() {
                return D(G.matches[G.index])
            }

            function j() {
                return t.isDefined(e.searchText) && e.searchText.length >= O()
            }
            ...
            function q(t) {
                e.selectedItem = G.matches[t], G.hidden = !0, G.index = 0, G.matches = [], d(function () {
                    Z.$.input.controller("ngModel").$setViewValue(D(e.selectedItem) || e.searchText), G.hidden = !0
                })
            }
            ...
            function V() {
                ...
                t.initCustomEvent("input", !0, !0, {value: e.searchText}), Z.input.dispatchEvent(t), Z.input.focus()
            }

            function U(n) {
                function o(t) {
                    ee[i] = t, n === e.searchText && (G.loading = !1, J = null, G.matches = t, G.hidden = P(), Y(), p())
                }

                var r = e.$parent.$eval(Q), i = n.toLowerCase();
                t.isArray(r) ? o(r) : r && (G.loading = !0, r.success && r.success(o), r.then && r.then(o), r.error && r.error(function () {
                    G.loading = !1
                }))
            }
            ...
            function K() {
                if (re === G.matches.length)return "";
                switch (re = G.matches.length, G.matches.length) {
                    case 0:
                        return "There are no matches available.";
                    case 1:
                        return "There is 1 match available.";
                    default:
                        return "There are " + G.matches.length + " matches available."
                }
            }

            function z() {
                if (Z.li[G.index]) {
                    var e = Z.li[G.index], t = e.offsetTop, n = t + e.offsetHeight, o = Z.ul.clientHeight;
                    t < Z.ul.scrollTop ? Z.ul.scrollTop = t : n > Z.ul.scrollTop + o && (Z.ul.scrollTop = n - o)
                }
            }

            function W() {
                var t = e.searchText, n = t.toLowerCase();
                J && J.cancel && (J.cancel(), J = null), !e.noCache && ee[n] ? (G.matches = ee[n], Y()) : U(t), oe && (G.hidden = P())
            }

            var G = this, X = e.itemsExpr.split(/ in /i), Q = X[1], Z = null, J = null, ee = {}, te = !1, ne = [], oe = !1, re = 0;
            return B("hidden", A, !0), G.scope = e, G.parent = e.$parent, G.itemName = X[0], G.matches = [], G.loading = !1, G.hidden = !0, G.index = null, G.messages = [], G.id = i.nextUid(), G.isDisabled = null, G.isRequired = null, G.keydown = I, G.blur = H, G.focus = S, G.clear = V, G.select = q, G.listEnter = C, G.listLeave = T, G.mouseUp = y, G.getCurrentDisplayValue = F, G.registerSelectedItemWatcher = x, G.unregisterSelectedItemWatcher = N, f()
        }

        t.module("material.components.autocomplete").controller("MdAutocompleteCtrl", e);
        var n = 41, o = 5.5 * n, r = 8;
        e.$inject = ["$scope", "$element", "$mdUtil", "$mdConstant", "$timeout", "$mdTheming", "$window", "$animate", "$rootElement", "$attrs"]
    }(), function () {
        function e(e, t) {
            return {
                ...
                template: function (e, t) {
                    function n() {
                        var t = e.find("md-item-template").remove(), n = t.length ? t.html() : e.html();
                        return t.length || e.empty(), n
                    }

                    function o() {
                        var t = e.find("md-not-found").remove(), n = t.length ? t.html() : "";
                        return n ? '<li ng-if="!$mdAutocompleteCtrl.matches.length && !$mdAutocompleteCtrl.loading                         && !$mdAutocompleteCtrl.hidden"                         ng-hide="$mdAutocompleteCtrl.hidden"                         md-autocomplete-parent-scope>' + n + "</li>" : ""
                    }
        ...
        t.module("material.components.autocomplete").directive("mdAutocomplete", e), e.$inject = ["$mdTheming", "$mdUtil"]
    }(), function () {
        function e(e, n, o) {
            function r(r) {
                var i = o(n.html())(e), d = t.element("<div>").text(i).html(), c = n.attr("md-highlight-flags") || "", l = e.$watch(r, function (e) {
                    var t = a(e, c), o = d.replace(t, '<span class="highlight">$&</span>');
                    n.html(o)
                });
            ...
            return this.init = r, r()
        }

        t.module("material.components.autocomplete").controller("MdHighlightCtrl", e), e.$inject = ["$scope", "$element", "$interpolate"];

    }(), function () {
        function e() {
            return {
                terminal: !0, scope: !1, controller: "MdHighlightCtrl", link: function (e, t, n, o) {
                    o.init(n.mdHighlightText)
                }
            }
        }
        ...
        function e(e, t) {
            function n(n, o, r) {
                var i = n.$parent.$mdAutocompleteCtrl, a = i.parent.$new(!1, i.parent), d = i.scope.$eval(r.mdAutocompleteListItem);
                a[d] = n.item, e(o.contents())(a), o.attr({role: "option", id: "item_" + t.nextUid()})
            }

            return {terminal: !0, link: n, scope: !1}
        }

        t.module("material.components.autocomplete").directive("mdAutocompleteListItem", e), e.$inject = ["$compile", "$mdUtil"]
    }(), function () {
        function e(e, t) {
            function n(t, n, o) {
                var r = t.$parent.$mdAutocompleteCtrl;
                e(n.contents())(r.parent), o.hasOwnProperty("mdAutocompleteReplace") && (n.after(n.contents()), n.remove())
            }

            return {restrict: "A", terminal: !0, link: n, scope: !1}
        }
        ...
        function e(e) {
            function o(o, r) {
                return o.append(n), function (n, o, r, i) {
            ...
            return {restrict: "E", require: "^?mdChips", compile: o}
        }
        ...
        function e(e, t) {
            function n(t, n, o) {
                ...
                i.$$replacedScope = t, i.$chip = t.$chip, i.$mdChipsCtrl = r, n.html(r.$scope.$eval(o.mdChipTransclude)), e(n.contents())(i)
            }

            return {restrict: "EA", terminal: !0, link: n, scope: !1}
        }

        t.module("material.components.chips").directive("mdChipTransclude", e), e.$inject = ["$compile", "$mdUtil"]
    }(), function () {
        ...
        t.module("material.components.chips").controller("MdChipsCtrl", e), e.$inject = ["$scope", "$mdConstant", "$log", "$element", "$timeout"], e.prototype.inputKeydown = function (e) {
            ...
            this.items.indexOf(e) + 1 || (this.useMdOnAppend && this.mdOnAppend && (e = this.mdOnAppend({$chip: e})), this.items.push(e))
            ...
            var o = this.$scope, r = this;
            e.attr({tabindex: 0}).on("keydown", function (e) {
                o.$apply(t.bind(r, function () {
                    r.inputKeydown(e)
                }))
            }).on("focus", t.bind(r, r.onInputFocus)).on("blur", t.bind(r, r.onInputBlur))
        ...
        function e(e, t, a, d, c) {
            function l(n, l) {
                ...
                var u = m("md-chips>*[md-chip-remove]") || i, f = m("md-chips>md-chip-template") || r, p = m("md-chips>md-autocomplete") || m("md-chips>input") || o, h = s.find("md-chip");
                return s[0].querySelector("md-chip-template>*[md-chip-remove]") && d.warn("invalid placement of md-chip-remove within md-chip-template."), function (n, r, i, d) {
                    t.initOptionalProperties(n, l), e(r);
                    var m = d[0];
                    if (m.chipContentsTemplate = f, m.chipRemoveTemplate = u, m.chipInputTemplate = p, r.attr({
                            ariaHidden: !0,
                            tabindex: -1
                        }).on("focus", function () {
                            m.onFocus()
                        }), l.ngModel && (m.configureNgModel(r.controller("ngModel")), i.mdOnAppend && m.useMdOnAppendExpression(), p != o && c(function () {
                            0 === p.indexOf("<md-autocomplete") && m.configureAutocomplete(r.find("md-autocomplete").controller("mdAutocomplete")), m.configureUserInput(r.find("input"))
                        })), h.length > 0) {
                        var s = a(h)(n.$parent);
                        c(function () {
                            r.find("md-chips-wrap").prepend(s)
                        })
                    }
                }
            }
        ...
        var n = '      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus() }"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div class="md-chip-remove-container"              md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>', o = '        <input            tabindex="0"            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.onInputFocus()"            ng-blur="$mdChipsCtrl.onInputBlur()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">', r = "      <span>{{$chip}}</span>", i = '      <button          class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          type="button"          aria-hidden="true"          tabindex="-1">        <md-icon md-svg-icon="md-close"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';
        ...
        function e() {
            function e(e, n, o, r) {
                if (r) {
                    var i = n.parent()[0].getElementsByTagName("md-tab"), a = Array.prototype.indexOf.call(i, n[0]), d = n.find("md-tab-body").eq(0).remove(), c = n.find("md-tab-label").eq(0).remove(), l = r.insertTab({
                        scope: e,
                        parent: e.$parent,
                        index: a,
                        element: n,
                    ...
                    e.select = e.select || t.noop, e.deselect = e.deselect || t.noop, e.$watch("active", function (e) {
                        e && r.select(l.getIndex())
                    }), e.$watch("disabled", function () {
                        r.refreshIndex()
                    }), e.$watch(function () {
                        return Array.prototype.indexOf.call(i, n[0])
                    }, function (e) {
                        l.index = e, r.updateTabOrder()
            ...
            return {
                ...
                template: function (e, t) {
                    function n() {
                        ...
                        function o() {
                            var t = e.find("md-tab-label").eq(0);
                            return t.length ? t.remove().html() : void 0
                        }
                    ...
                    function o() {
                        var n = e.find("md-tab-body").eq(0), o = n.length ? n.html() : t.label ? e.html() : "";
                        return n.length ? n.remove() : t.label && e.empty(), o
                    }

                    var r = n(), i = o();
                    return "<md-tab-label>" + r + "</md-tab-label><md-tab-body>" + i + "</md-tab-body>"
                },
                scope: {
                    active: "=?mdActive",
                    disabled: "=?ngDisabled",
        ...
        function e(e, n, o, r, i, a, d, c, l, m, s) {
            function u() {
                e.selectedIndex = e.selectedIndex || 0, f(), h(), p(), s(n), r(function () {
                    K(), q(), P(), Q.tabs[e.selectedIndex] && Q.tabs[e.selectedIndex].scope.select(), ne = !0
                })
            }

            function f() {
                var e = l.$mdTabsTemplate, n = t.element(J.data);
                n.html(e), m(n.contents())(Q.parent), delete l.$mdTabsTemplate
            }

            function p() {
                t.element(o).on("resize", w), t.element(J.paging).on("DOMSubtreeModified", Q.updateInkBarStyles), t.element(J.paging).on("DOMSubtreeModified", P)
            }

            function h() {
                d.initOptionalProperties(e, l), l.$observe("mdNoBar", function (n) {
                    e.noInkBar = t.isDefined(n)
                }), e.$watch("selectedIndex", M), e.$watch("dynamicHeight", function (e) {
                    e ? n.addClass("md-dynamic-height") : n.removeClass("md-dynamic-height")
                }), e.$on("$destroy", b)
            }

            function b() {
                te = !0, t.element(o).off("resize", w), t.element(J.paging).off("DOMSubtreeModified", Q.updateInkBarStyles), t.element(J.paging).off("DOMSubtreeModified", P)
            }
            ...
            function E(n) {
                var o = Q.shouldCenterTabs ? "" : "-" + n + "px";
                t.element(J.paging).css(i.CSS.TRANSFORM, "translate3d(" + o + ", 0, 0)"), e.$broadcast("$mdTabsPaginationChanged")
            }
            ...
            function M(t, n) {
                t !== n && (e.selectedIndex = R(t), Q.lastSelectedIndex = n, Q.updateInkBarStyles(), K(), q(t), e.$broadcast("$mdTabsChanged"), Q.tabs[n] && Q.tabs[n].scope.deselect(), Q.tabs[t] && Q.tabs[t].scope.select())
            }

            function $() {
                $.watcher || ($.watcher = e.$watch(function () {
                    r(function () {
                        $.watcher && n.prop("offsetParent") && ($.watcher(), $.watcher = null, w())
                    }, 0, !1)
                }))
            }
            ...
            function A(t) {
                switch (t.keyCode) {
                    ...
                    case i.KEY_CODE.ENTER:
                        t.preventDefault(), Z || (e.selectedIndex = Q.focusIndex)
                }
                Q.lastClick = !1
            }

            function C(t) {
                Z || (Q.focusIndex = e.selectedIndex = t), Q.lastClick = !0, Q.tabs[t].element.triggerHandler("click")
            }

            function T(e) {
                Q.shouldPaginate && (e.preventDefault(), Q.offsetLeft = G(Q.offsetLeft - e.wheelDelta))
            }

            function y() {
                var e, t, n = J.canvas.clientWidth, o = n + Q.offsetLeft;
                for (e = 0; e < J.tabs.length && (t = J.tabs[e], !(t.offsetLeft + t.offsetWidth > o)); e++);
                Q.offsetLeft = G(t.offsetLeft)
            }

            function k() {
                var e, t;
                for (e = 0; e < J.tabs.length && (t = J.tabs[e], !(t.offsetLeft + t.offsetWidth >= Q.offsetLeft)); e++);
                Q.offsetLeft = G(t.offsetLeft + t.offsetWidth - J.canvas.clientWidth)
            }

            function w() {
                e.$apply(function () {
                    Q.lastSelectedIndex = e.selectedIndex, Q.offsetLeft = G(Q.offsetLeft), r(Q.updateInkBarStyles, 0, !1), r(P)
                })
            }

            function x(t) {
                var n = e.selectedIndex, o = Q.tabs.splice(t.getIndex(), 1)[0];
                Y(), e.selectedIndex !== n || te || (o.scope.deselect(), Q.tabs[e.selectedIndex] && Q.tabs[e.selectedIndex].scope.select()), r(function () {
                    P(), Q.offsetLeft = G(Q.offsetLeft)
                })
            }
            ...
            function N(n, o) {
                var i = {
                    getIndex: function () {
                        ...
                        return !e.noDisconnect || this.isActive()
                    }, hasFocus: function () {
                        return !Q.lastClick && Q.hasFocus && this.getIndex() === Q.focusIndex
                    }, id: d.nextUid()
                }, a = t.extend(i, n);
                return t.isDefined(o) ? Q.tabs.splice(o, 0, a) : Q.tabs.push(a), V(), U(), ne && e.autoselect && r(function () {
                    C(Q.tabs.indexOf(a))
                }), r(P), a
            }
            ...
            function H() {
                return Q.offsetLeft > 0
            }

            function S() {
                var e = J.tabs[J.tabs.length - 1];
                return e && e.offsetLeft + e.offsetWidth > J.canvas.clientWidth + Q.offsetLeft
            }
            ...
            function I() {
                switch (e.stretchTabs) {
                    ...
                    case"never":
                        return !1;
                    default:
                        return !Q.shouldPaginate && o.matchMedia("(max-width: 600px)").matches
                }
            }

            function O() {
                return e.centerTabs && !Q.shouldPaginate
            }

            function D() {
                if (e.noPagination || !ne)return !1;
                var o = n.prop("clientWidth");
                return t.forEach(J.dummies, function (e) {
                    o -= e.offsetWidth
                }), 0 > o
            }

            function R(e) {
                var t, n, o = Math.max(Q.tabs.length - e, e);
                for (t = 0; o >= t; t++) {
                    if (n = Q.tabs[e + t], n && n.scope.disabled !== !0)return n.getIndex();
                    if (n = Q.tabs[e - t], n && n.scope.disabled !== !0)return n.getIndex()
                }
                return e
            }
            ...
            function P() {
                Q.shouldPaginate = D(), Q.shouldCenterTabs = O(), r(function () {
                    q(e.selectedIndex)
                })
            }

            function F() {
                var t = Q.tabs[e.selectedIndex], n = Q.tabs[Q.focusIndex];
                Q.tabs = Q.tabs.sort(function (e, t) {
                    return e.index - t.index
                }), e.selectedIndex = Q.tabs.indexOf(t), Q.focusIndex = Q.tabs.indexOf(n)
            }

            function j(e) {
                var t, n = Q.focusIndex;
                for (t = n + e; Q.tabs[t] && Q.tabs[t].scope.disabled; t += e);
                Q.tabs[t] && (Q.focusIndex = t)
            }

            function B() {
                J.dummies[Q.focusIndex].focus()
            }

            function q(e) {
                if (!Q.shouldCenterTabs) {
                    null == e && (e = Q.focusIndex);
                    var t = J.tabs[e], n = t.offsetLeft, o = t.offsetWidth + n;
                    Q.offsetLeft = Math.max(Q.offsetLeft, G(o - J.canvas.clientWidth)), Q.offsetLeft = Math.min(Q.offsetLeft, G(n))
                }
            }
            ...
            function U() {
                var e = !1;
                t.forEach(Q.tabs, function (t) {
                    t.template && (e = !0)
                }), Q.hasContent = e
            }

            function Y() {
                e.selectedIndex = R(e.selectedIndex), Q.focusIndex = R(Q.focusIndex)
            }

            function K() {
                if (!e.dynamicHeight)return n.css("height", "");
                if (!Q.tabs.length)return ee.push(K);
                var t = J.contents[e.selectedIndex], o = t ? t.offsetHeight : 0, r = J.wrapper.offsetHeight, i = o + r, a = n.prop("clientHeight");
                a !== i && (Z = !0, c.animate(n, {height: a + "px"}, {height: i + "px"}).then(function () {
                    n.css("height", ""), Z = !1
                }))
            }

            function z() {
                if (J.tabs[e.selectedIndex]) {
                    if (!Q.tabs.length)return ee.push(Q.updateInkBarStyles);
                    if (!n.prop("offsetParent"))return $();
                    var o = e.selectedIndex, r = J.paging.offsetWidth, i = J.tabs[o], a = i.offsetLeft, d = r - a - i.offsetWidth;
                    W(), t.element(J.inkBar).css({left: a + "px", right: d + "px"})
                }
            }

            function W() {
                var n = e.selectedIndex, o = Q.lastSelectedIndex, r = t.element(J.inkBar);
                t.isNumber(o) && (o > n ? r.addClass("md-left").removeClass("md-right") : n > o && r.addClass("md-right").removeClass("md-left"))
            }

            function G(e) {
                if (!J.tabs.length || !Q.shouldPaginate)return 0;
                var t = J.tabs[J.tabs.length - 1], n = t.offsetLeft + t.offsetWidth;
                return e = Math.max(0, e), e = Math.min(n - J.canvas.clientWidth, e)
            }

            function X(e, n) {
                var o = {colorElement: t.element(J.inkBar)};
                a.attach(e, n, o)
            }

            var Q = this, Z = !1, J = _(), ee = [], te = !1, ne = !1;
            L("focusIndex", v, e.selectedIndex || 0), L("offsetLeft", E, 0), L("hasContent", g, !1), Q.scope = e, Q.parent = e.$parent, Q.tabs = [], Q.lastSelectedIndex = null, Q.hasFocus = !1, Q.lastClick = !0, Q.shouldPaginate = !1, Q.shouldCenterTabs = O(), Q.redirectFocus = B, Q.attachRipple = X, Q.shouldStretchTabs = I, Q.insertTab = N, Q.removeTab = x, Q.select = C, Q.scroll = T, Q.nextPage = y, Q.previousPage = k, Q.keydown = A, Q.canPageForward = S, Q.canPageBack = H, Q.refreshIndex = Y, Q.incrementSelectedIndex = j, Q.updateInkBarStyles = d.debounce(z, 100), Q.updateTabOrder = d.debounce(F, 100), u()
        }

        t.module("material.components.tabs").controller("MdTabsController", e), e.$inject = ["$scope", "$element", "$window", "$timeout", "$mdConstant", "$mdTabInkRipple", "$mdUtil", "$animate", "$attrs", "$compile", "$mdTheming"]
    }(), function () {
        function e(e, t, n) {
            return {
                scope: {
        ...
        function e(e, t, n) {
            ...
            return {
                restrict: "A",
                link: o,
                scope: {template: "=mdTemplate", compileScope: "=mdScope", connected: "=?mdConnectedIf"},
                require: "^?mdTabs"
            }
        }

        t.module("material.components.tabs").directive("mdTemplate", e), e.$inject = ["$compile", "$mdUtil", "$timeout"]
    }(), function () {
